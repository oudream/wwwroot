                  ...
                  <TBODY>
                    <TR> 
                      <TD vAlign=top width=414> <TABLE border=0 cellPadding=0 cellSpacing=0 width=414>
                          <TBODY>
                            <TR> 
                              <TD class=header><p><b>WOMEN</b></p></TD>
                              <TD align=right class=icons><NOBR> <font color="#990000"><img src="images/dot-7.gif" width="8" height="10" border="0"></font> 
                                <font color="#990000">Products Guide.</font></NOBR></TD>
                            </TR>
                            <TR> 
                        ...
                        href="women_view.asp">New products</A></NOBR></TD>
                            </TR>
                            <TR> 
                              <TD background=images/hpx.jpg 
                        colSpan=2><IMG height=2 
                        ...
                        src="images/px.gif" width=1></TD>
                            ...
                            <TR align=left vAlign=top> 
                              <TD colSpan=2> <%
dim women_l(2)
sql="select * from subs where sort_id=2210 or sort_id=2211  or sort_id=2212  or sort_id=2213 order by subs_id desc "
Set rs=Server.CreateObject("ADODB.RecordSet") 
rs.open sql,conn,1,1 
do while not rs.eof 
select case rs("sort_id")
case 2210 women_r="women/"+rs("pic")
case 2211 women_l(0)="women/"+rs("pic")
case 2212 women_l(1)="women/"+rs("pic")
case 2213 women_l(2)="women/"+rs("pic")
end select
rs.movenext
loop
rs.close
...
%> <TABLE border=0 cellPadding=0 cellSpacing=0 width=414>
                                  <TBODY>
                                    <TR align=left vAlign=top> 
                                      <TD width=131><IMG 
                              src="<%=women_l(0)%>" width="130" height="182" border=0></TD>
                                      <TD width=10>&nbsp;</TD>
                                      <TD width=131><img src="<%=women_l(1)%>" width="130" height="182"></TD>
                                      <TD width=10>&nbsp;</TD>
                                      <TD width=132><img 
                              src="<%=women_l(2)%>" width="130" height="182" border=0></TD>
                                    </TR>
                                  </TBODY>
                                </TABLE></TD>
                            </TR>
                      ...
                      bgColor=#ffffff class=power vAlign=bottom width=150><IMG 
                        src="<%=women_r%>" width=150 height=227 
                        border=0></TD>
                              <TD align=right width=8>&nbsp;</TD>
                            </TR>
                          </TBODY>
                        </TABLE>
                        <P><img src="images/r-w.gif" width="150" height="109"></P>
