                  ...
                  <TBODY>
                    <TR> 
                      <TD vAlign=top> <br> <table border="0" width="100%" cellspacing="1">
                          <tr> 
                            <%
sql="select * from subs where sort_id=11 order by subs_id desc "
...
%>
                            <td valign="top" bgcolor="#FFFFFF"> <table borderColorDark=#ffffff borderColorLight=#B5C9E7 width="140" border="1" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td valign="top"> <a href="<%="men/"&rs("photo")%>" target="_blank"><img border="0" src="<%="men/"+rs("pic")%>" width="138" height="182"></a> 
                                   </td>
                                </tr>
...
%> <a href="men_view.asp?page=<%=zj%>">&nbsp;<%=zj%>&nbsp;</a> <%
							end if
zj=zj+1
next
rs.close
...
sql="select * from subs where sort_id=1110"
rs.open sql,conn,3,3
men_r="men/"+rs("pic")
rs.close
set rs=nothing
