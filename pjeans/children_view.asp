...
<html>
<head>
<title>CHILDREN'S PRODUCTS , PJEANS.COM</title>
                  ...
                  <TBODY>
                    <TR> 
                      <TD vAlign=top> <br> <table border="0" width="100%" cellspacing="1">
                          <tr> 
                            <%
sql="select * from subs where sort_id=33 order by subs_id desc "
...
%>
							...
							<table borderColorDark=#ffffff borderColorLight=#B5C9E7 width="140" border="1" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td valign="top"> <a href="<%="children/"&rs("photo")%>" target="_blank"><img border="0" src="<%="children/"+rs("pic")%>" width="138" height="182"></a> 
                                  </td>
                                </tr>
                              </table>
							  <table width="140" border="0" align="center" cellpadding="2" cellspacing="2">
                                <tr>
                                  <td><%=rs("name")%></td>
                                </tr>
                              </table></td>
...
%> <a href="children_view.asp?page=<%=zj%>">&nbsp;<%=zj%>&nbsp;</a> <%
							end if
zj=zj+1
next
rs.close
...
sql="select * from subs where sort_id=3310"
rs.open sql,conn,3,3
children_r="children/"+rs("pic")
rs.close
set rs=nothing
%> <TABLE border=0 cellPadding=0 cellSpacing=0 width=166>
                      ...
                      bgColor=#ffffff vAlign=bottom width=150>&nbsp;</TD>
                            ...
                            <TR> 
                              <TD width=8>&nbsp;</TD>
                              <TD align=right background=images/px.gif 
                      bgColor=#ffffff class=power vAlign=bottom width=150> <IMG src="<%=children_r%>" width=150 height=227 
                        border=0></TD>
                              <TD align=right width=8>&nbsp;</TD>
                            </TR>
                          </TBODY>
