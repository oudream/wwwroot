...
sql="select * from admin_users where adminlevel=1 order by pid desc"
admin_str="Administrators"
end if
if adminlevel=2 then 
sql="select * from admin_users where adminlevel=2 order by pid desc" 
admin_str="Managers"
end if
if adminlevel=3 then 
sql="select * from admin_users where adminlevel=3 order by pid desc" 
admin_str="Visitors"
end if
if adminlevel=5 then 
sql="select * from admin_users where adminlevel=5 order by pid desc" 
