...
conn.execute "delete * from admin_users where pid=" & id
...
usql="select * from admin_users where pid<>"&id&"and uid='"&uid&"'"
...
if nric="" then nric=" "
if uname<>"" then
conn.Execute("update admin_users set name='"&uname&"',tel='"&tel&"',zip='"&zip&"',contact='"&contact&"',email='"&email&"',nric='"&nric&"',uid='"&uid&"',pwd='"&pwd&"' where pid=" & id)
...
%>
<%
sql="select * from admin_users where pid=" & id
