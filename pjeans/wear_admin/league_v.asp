...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
 ...
 ======================================================================================================== -->
      <table width="100%" border="1" cellpadding="2" cellspacing="0" bordercolor="#CCCCCC">
        ...
        <%
sql="select * from tournament where type='league' order by cid desc" 
...
%>
        <tr bgcolor="#FFFFFF"> 
          <td height="19" align="center"><%=rs("cid")%>&nbsp;</td>
...
%> &nbsp;</td>
          ...
          <td width="30" align="center"><a href="league_v.asp?cid=<%=rs("cid")%>&option=del"% onClick="return confirm(' Are you sure to del the tournament ?')">Del</a></td>
        </tr>
        <%
rs.movenext
loop
