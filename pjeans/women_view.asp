                  ...
                  <TBODY>
                    <TR> 
                      <TD vAlign=top> <br> <table border="0" width="100%" cellspacing="1">
                          <tr> 
                            <%
sql="select * from subs where sort_id=22 order by subs_id desc "
...
i=i+1
%>
                            <td valign="top" bgcolor="#FFFFFF"> <table borderColorDark=#ffffff borderColorLight=#B5C9E7 width="140" border="1" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td valign="top"> <a href="<%="women/"&rs("photo")%>" target="_blank"><img border="0" src="<%="women/"+rs("pic")%>" width="138" height="182"></a> 
                                    </td>
                                </tr>
                              </table><table width="140" border="0" align="center" cellpadding="2" cellspacing="2">
                                <tr>
                                  <td><%=rs("name")%></td>
                                </tr>
                              </table></td>
...
%> <a href="women_view.asp?page=<%=zj%>">&nbsp;<%=zj%>&nbsp;</a> <%
							end if
zj=zj+1
next
rs.close
...
%> <TABLE border=0 cellPadding=0 cellSpacing=0 width=166>
                      ...
                      bgColor=#ffffff vAlign=bottom width=150>&nbsp;</TD>
                            ...
                            <TR> 
                              <TD width=8>&nbsp;</TD>
                              <TD align=right background=images/px.gif 
                      bgColor=#ffffff class=power vAlign=bottom width=150> <IMG src="<%=women_r%>" width=150 height=227 
                        border=0></TD>
                              <TD align=right width=8>&nbsp;</TD>
                            </TR>
                          </TBODY>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td class=size10> New fashion statement 
                              makers will emerge as we approach the middle of 
                              the first decade of the 21st century. Global trends 
                              now emerge faster than ever before as the internet 
                              and text messaging, shortcuts transmission of ideas 
                              and concepts between individuals, bringing the next 
                              big thing to you and me in the space of seconds. 
                              </td>
                          </tr>
                        </table></TD>
                    </TR>
