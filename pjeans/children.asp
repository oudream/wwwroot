...
<html>
<head>
<title>CHILDREN , PJEANS.COM</title>
                  ...
                  <TBODY>
                    <TR> 
                      <TD vAlign=top width=414> <TABLE border=0 cellPadding=0 cellSpacing=0 width=414>
                          <TBODY>
                            <TR> 
                              <TD class=header><p><B>CHILDREN</B></p></TD>
                              <TD align=right class=icons><NOBR> <font color="#990000"><img src="images/dot-7.gif" width="8" height="10" border="0"> 
                                Products Guide.</font></NOBR></TD>
                            </TR>
                            <TR> 
                        ...
                        href="children_view.asp">New products</A></NOBR></TD>
                            </TR>
                            <TR> 
                              <TD background=images/hpx.jpg 
                        colSpan=2><IMG height=2 
                        ...
                        src="images/px.gif" width=1></TD>
                            ...
                            <TR align=left vAlign=top> 
                              <TD colSpan=2> <%
dim children_l(2)
sql="select * from subs where sort_id=3310 or sort_id=3311  or sort_id=3312  or sort_id=3313 order by subs_id desc "
Set rs=Server.CreateObject("ADODB.RecordSet") 
rs.open sql,conn,1,1 
do while not rs.eof 
select case rs("sort_id")
case 3310 children_r="children/"+rs("pic")
case 3311 children_l(0)="children/"+rs("pic")
case 3312 children_l(1)="children/"+rs("pic")
case 3313 children_l(2)="children/"+rs("pic")
end select
rs.movenext
loop
rs.close
...
%> <TABLE border=0 cellPadding=0 cellSpacing=0 width=414>
                                  <TBODY>
                                    <TR align=left vAlign=top> 
                                      <TD width=131><IMG 
                              src="<%=children_l(0)%>" width="130" height="182" border=0></TD>
                                      <TD width=10>&nbsp;</TD>
                                      <TD width=131><img src="<%=children_l(1)%>" width="130" height="182"></TD>
                                      <TD width=10>&nbsp;</TD>
                                      <TD width=132><img src="<%=children_l(2)%>" width="130" height="182"></TD>
                                    </TR>
                                  </TBODY>
                                </TABLE></TD>
                            </TR>
                      ...
                      bgColor=#ffffff vAlign=bottom width=150>&nbsp;</TD>
                            ...
                            <TR> 
                              <TD width=8>&nbsp;</TD>
                              <TD align=right background=images/px.gif 
                      bgColor=#ffffff class=power vAlign=bottom width=150><IMG 
                        src="<%=children_r%>" width=150 height=211 
                        border=0></TD>
                              <TD align=right width=8>&nbsp;</TD>
                            </TR>
                          </TBODY>
