...
<%
sql="select * from art_shopper_govermente order by allname" 
...
%>
                <td width="50"><a href="art_shopper_govermente_view.asp?page=<%=zj%>">&nbsp;<%=zj%>&nbsp;</a></td>
                <%
zj=zj+1
next
%>
  ...
  <tr> 
    ...
    <td width="80" bgcolor="#FFFFFF">联系人</td>
    <td width="150" bgcolor="#FFFFFF">地方历史及文化</td>
  </tr>
  <%
do while not rs.eof 
%>
