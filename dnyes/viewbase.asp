            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td width="583"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr valign="top"> 
                      <td colspan="2">+ <%=zname%> +<br>
                        <img src="images/other-1.gif" width="513" height="12"></td>
                    </tr>
                    <%
...
%>
                    <tr> 
                      <td width="25" height="22" align="center"><img src="images/dot-6.gif" width="8" height="6" border="0"></td>
...
%>
              ...
              <tr> 
                <td>&nbsp; <div align="right">共&nbsp;<%=amount%>&nbsp;个&nbsp;&nbsp;每页&nbsp;20&nbsp;个&nbsp;&nbsp;<font color=red><%=pagecount%></font>/<%=rsnews.pagecount%> 
                    ...
                    <a href="viewbase.asp?newstype=<%=zname%>&page=<%=cstr(pagecount+1)%>"><font color="#ff0000">下一页</font></a><font color="#ff0000"> 
                    <% end if %>
                    <% if rsnews.pagecount>1 and rsnews.pagecount=pagecount then %>
                    <a href="viewbase.asp?newstype=<%=zname%>&page=<%=cstr(pagecount-1)%>"> 
                    上一页</a> 
                    <%end if%>
                    <% if pagecount<>1 and rsnews.pagecount<>pagecount then%>
                    <a href="viewbase.asp?newstype=<%=zname%>&page=<%=cstr(pagecount-1)%>">上一页</a> 
                    <a href="viewbase.asp?newstype=<%=zname%>&page=<%=cstr(pagecount+1)%>"><font color="#ff0000">下一页</font></a><font color="#ff0000"> 
                    <% end if%>
                    &nbsp;</font></font></div></td>
              </tr>
