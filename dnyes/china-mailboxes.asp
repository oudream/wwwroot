...
<html>
<head>
<title>信网 数信科技-全球顶级企业邮局系统 IDC专用1U服务器 Fsat.server服务器</title>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
<meta name="keywords" content="www.dnyes.com-mail,全球顶级企业邮局系统,独立邮件服务器与WEB服务器完全分离,自动回复,自动转发,中文界面管理,POP3、SMTP方式收发信,SMTP发信认证,邮件过滤、邮件拒收,定制邮件数、邮件大小">
<meta name="description" content="www.dnyes.com-mail,全球顶级企业邮局系统,独立邮件服务器与WEB服务器完全分离,自动回复,自动转发,中文界面管理,POP3、SMTP方式收发信,SMTP发信认证,邮件过滤、邮件拒收,定制邮件数、邮件大小">
              ...
              <tr> 
                ...
                style="BORDER-left: #000000 1px solid"><img src="1.gif" width="1" height="1"></TD>
                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><!--#include file="aboutmail.asp" --></td>
                    </tr>
                  </table>
                          ...
                          <TBODY>
                            <TR> 
                              <TD width="34%" vAlign=center style="BORDER-left: #CCCCCC 1px solid; BORDER-RIGHT: #CCCCCC 1px solid; BORDER-BOTTOM: #CCCCCC 1px solid;BORDER-TOP: #CCCCCC 1px solid"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                                  <tr> 
                                    <td background="images/host-2.gif"><img src="images/pro_mail.gif" width="153" height="25"></td>
                                  </tr>
                                </table>
                                <br> 
                                <br> 
...
%> 
   <a href="china-mailboxes.asp?page=<%=zj%>">|&nbsp;<%=zj%>&nbsp;|</a>         
<%
...
%> 
                                        ...
                                        <a href="china-mailboxes.asp?page=<%=cstr(pagecount+1)%>"><font color="#ff0000">下一页</font></a><font color="#ff0000"> 
                                        <% end if %>
                                        <% if rs.pagecount>1 and rs.pagecount=pagecount then %>
                                        <a href="china-mailboxes.asp?page=<%=cstr(pagecount-1)%>"> 
                                        上一页</a> 
                                        <%end if%>
                                        <% if pagecount<>1 and rs.pagecount<>pagecount then%>
                                        <a href="china-mailboxes.asp?page=<%=cstr(pagecount-1)%>">上一页</a> 
                                        <a href="china-mailboxes.asp?page=<%=cstr(pagecount+1)%>"><font color="#ff0000">下一页</font></a><font color="#ff0000"> 
                                        <% end if%>											</td>
                                          </tr>
                                        </table>
