...
<table width="212" border="0" cellpadding="0" cellspacing="0">
  <%
sqlnews="select * from sample_site order by id desc" 
...
%>
  <tr> 
    ...
    <td><a href="http://<%=rsnews("addr")%>" title="<%=rsnews("sample_site_name")%>" target="_blank"> 
      <%=rsnews("sample_site_name")%> </a></td>
  </tr>
  <%
n=n+1
rsnews.movenext
...
%>
  <tr> 
    <td colspan="2"><div align="right"><a href="china-ecompany-sample.asp" ><font color="#FF0000">更多建站客户展示&gt;&gt;</font></a></div></td>
  </tr>
</table>
<TABLE width=70% border=0 cellPadding=0 cellSpacing=0>
  <TBODY>
