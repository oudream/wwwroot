...
<html>
<head>
<title>信网 数信科技-企业信息化 电子商务服务实现 展现企业形象 产品展示交流</title>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
<meta name="keywords" content="www.dnyes.com-china-ecompany,企业网站建设,网站策划,网页制作,电子商务服务,企业信息化交流,实时产品展示,企业信息发布和实现电子商务">
<meta name="description" content="www.dnyes.com-china-ecompany,企业网站建设,网站策划,网页制作,电子商务服务,企业信息化交流,实时产品展示,企业信息发布和实现电子商务">
    ...
    <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          <td width="229" valign="top" background="images/left-228x5.gif"> <TABLE width=100% border=0 cellPadding=0 cellSpacing=0 bgcolor="#FFFFFF">
            ...
            <table width="229" border="0" cellpadding="0" cellspacing="0">
              <tr> 
                <td width="229" height="28" background="images/left-2.gif"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="82%" valign="bottom"><font color="#FFFFFF"><b>网站建设客户展示</b></font></td>
                    </tr>
                  </table></td>
              </tr>
              <tr> 
                ...
                style="BORDER-left: #000000 1px solid"><img src="1.gif" width="1" height="1"></TD>
                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><!--#include file="aboutsite.asp"--></td>
                    </tr>
                  </table>
              ...
              <tr> 
                ...
                style="BORDER-left: #000000 1px solid"><img src="1.gif" width="1" height="1"></TD>
                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><!--#include file="aboutecompany.asp" --></td>
                    </tr>
                  </table>
                  <TABLE width=100% border=0 cellPadding=0 cellSpacing=0 bgcolor="#FFFFFF">
                    <TBODY>
            ...
            <table width="229" border="0" cellpadding="0" cellspacing="0">
              <tr> 
                <td width="229" height="28" background="images/left-2.gif"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr> 
                      <td width="10%" height="18" valign="bottom">&nbsp; </td>
                      <td width="8%" valign="bottom"><img src="images/gogo.gif" width="6" height="15"></td>
                      <td width="82%" valign="bottom"><font color="#FFFFFF"><b>租 
                        用 流 程</b></font></td>
                    </tr>
                  </table>
              ...
              <tr> 
                ...
                style="BORDER-left: #000000 1px solid"><img src="1.gif" width="1" height="1"></TD>
                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td background="images/left-228x5.gif"><TABLE width=70% border=0 cellPadding=0 cellSpacing=0>
                          <TBODY>
                            <TR> 
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <tr> 
                            <td>&nbsp;</td>
                            <td width="199" height="20" align="right"><a href="servicefollow.asp" target="_blank">更多&gt;&gt;</a></td>
                            <td width="17">&nbsp;</td>
                          </tr>
                        </table>
            ...
            <table width="229" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                ...
                style="BORDER-left: #000000 1px solid"><img src="1.gif" width="1" height="1"></TD>
                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td background="images/left-228x5.gif">
                        <!--#include file="faqecompany.asp" -->
                      </td>
                    </tr>
                  </table>
                  <TABLE width=100% border=0 cellPadding=0 cellSpacing=0 bgcolor="#FFFFFF">
            ...
            ><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td><!--#include file="support.asp" --></td>
              </tr>
            </table>
                          ...
                          <TBODY>
                            <TR> 
                              <TD width="34%" vAlign=center style="BORDER-left: #CCCCCC 1px solid; BORDER-RIGHT: #CCCCCC 1px solid; BORDER-BOTTOM: #CCCCCC 1px solid;BORDER-TOP: #CCCCCC 1px solid"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                                  <tr> 
                                    <td background="images/host-2.gif"><img src="images/pro_site.GIF" width="153" height="25"></td>
                                  </tr>
                                </table>
                                <br>
                                <br> 
...
%>
                                ...
                                <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                  <tr> 
                                    <td width="120" align="center" valign="top"><a href="showsubs.asp?id=<%=rs("id")%>" target="_blank"><img src=<%=rs("photo")%> border="0" width="100" height="120"></a></td>
                                    <td><TABLE bgColor=#cccccc border=0 
                              cellPadding=5 cellSpacing=1 width="100%">
                                        <TBODY>
                                          <TR bgColor=#f5f5f5> 
                                            <TD height=18 width="50%"><B>编号：</B> <%=rs("id")%> 
                                            </TD>
                                            <TD bgColor=#f5f5f5 height=18> <DIV align=left><FONT color=#666666>[服务商： <%=rs("gys")%>]</FONT></DIV></TD>
                                          </TR>
                                          <TR bgColor=#f5f5f5> 
                                            <TD height=18><B>名称：</B> <%=rs("subsname")%> 
                                            </TD>
                                            <TD height=18> <DIV align=left><font color=#666666>[类&nbsp;&nbsp;别： <%=area%>]</font></DIV></TD>
                                          </TR>
                                          <TR bgColor=#f5f5f5> 
                                            <TD height=18><B>单价：</B><FONT color=#000000>
                                            ...
                                            <TD height=18 bgcolor="#f5f5f5">&nbsp;</TD>
                                          </TR>
                                          <TR bgColor=#ffffff vAlign=top> 
                                            <TD colSpan=2 height=46><b>简&nbsp;&nbsp;介：</b><br><br><%=brief%>
                                          </TD>
                                          </TR>
                                          <TR bgColor=#ffffff> 
                                            <TD colSpan=2>
                                ...
                                width="100%" border=0 cellPadding=0 cellSpacing=0>
                                                <TBODY>
                                                  <TR> 
                                                    <TD width=85><a href="add.asp?add=<%=rs("bookbm")%>" target="_blank"><img src="images/IN3.GIF" width="82" height="18" border="0"></a></TD>
                                                    <TD width=85><a href="showsubs.asp?id=<%=rs("id")%>" target="_blank"><img src="images/more.gif" width="82" height="18" border="0"></a></TD>
                                                    <TD width=85>&nbsp;</TD>
                                                    <TD 
                                width=85></TD>
                                                  </TR>
                                  ...
                                  <tr> 
                                    <td><table width="100%" border="0" cellpadding="0" cellspacing="1">
                                        <tr> 
                                          ...
                                          <td width="90"><a href="ecompany_brief.asp" target="_blank"><font color="#FF0000">&lt;</font><font color="#FF0000">&nbsp;网站制作概述</font></a></td>
                                          <td width="90"><a href="ecompany_step.asp" target="_blank"><font color="#FF0000">网站制作步骤</font></a></td>
                                          <td width="90"><a href="ecompany_stard.asp" target="_blank"><font color="#FF0000">网站制作规划</font></a></td>
                                          <td width="90"><a href="ecompany_detail.asp" target="_blank"><font color="#FF0000">明细价格列表</font></a></td>
                                          <td width="88"><a href="ecompany_detail_system.asp" target="_blank"><font color="#FF0000">系统价格查询&nbsp;&gt;</font></a> 
                                            </td>
                                        </tr>
                                      </table>
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
...
%> 
   <a href="china-ecompany.asp?page=<%=zj%>">|&nbsp;<%=zj%>&nbsp;|</a>         
<%
...
%> 
                                        ...
                                        <a href="china-ecompany.asp?page=<%=cstr(pagecount+1)%>"><font color="#ff0000">下一页</font></a><font color="#ff0000"> 
                                        <% end if %>
                                        <% if rs.pagecount>1 and rs.pagecount=pagecount then %>
                                        <a href="china-ecompany.asp?page=<%=cstr(pagecount-1)%>"> 
                                        上一页</a> 
                                        <%end if%>
                                        <% if pagecount<>1 and rs.pagecount<>pagecount then%>
                                        <a href="china-ecompany.asp?page=<%=cstr(pagecount-1)%>">上一页</a> 
                                        <a href="china-ecompany.asp?page=<%=cstr(pagecount+1)%>"><font color="#ff0000">下一页</font></a><font color="#ff0000"> 
                                        <% end if%>											</td>
                                          </tr>
                                        </table>
