...
<html>
<head>
<title>信网 数信科技- 论坛专用主机 双IDC加强型主机</title>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
<meta name="keywords" content="www.dnyes.com-special-hosting-service,论坛专用主机,双IDC加强型主机">
<meta name="description" content="www.dnyes.com-special-hosting-service,论坛专用主机,双IDC加强型主机">
              ...
              <tr> 
                ...
                style="BORDER-left: #000000 1px solid"><img src="1.gif" width="1" height="1"></TD>
                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><!--#include file="abouthost.asp"--></td>
                    </tr>
                  </table>
                          ...
                          <TBODY>
                            <TR> 
                              <TD width="34%" vAlign=center style="BORDER-left: #CCCCCC 1px solid; BORDER-RIGHT: #CCCCCC 1px solid; BORDER-BOTTOM: #CCCCCC 1px solid;BORDER-TOP: #CCCCCC 1px solid"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                                  <tr> 
                                    <td background="images/host-2.gif"><img src="images/host-sp.gif" width="153" height="25"></td>
                                  </tr>
                                </table>
                                <br> 
                                <br> 
...
%>
                              ...
                              cellPadding=5 cellSpacing=1 width="100%">
                                        <TBODY>
                                          <TR bgColor=#f5f5f5> 
                                            <TD height=18 width="55%"><B>编号：</B> <%=rs("id")%> 
                                            </TD>
                                            <TD width="45%" height=18 bgColor=#f5f5f5> <DIV align=left><FONT color=#666666>[服务商： <%=rs("gys")%>]</FONT></DIV></TD>
                                          </TR>
                                          <TR bgColor=#f5f5f5> 
                                            <TD height=18><B>名称：</B> <%=rs("subsname")%> 
                                            </TD>
                                            <TD height=18> <DIV align=left><font color=#666666>[类&nbsp;&nbsp;别： 专用主机]</font></DIV></TD>
                                          </TR>
                                          <TR bgColor=#f5f5f5> 
...
%> 
   <a href="Special-Hosting-Service.asp?page=<%=zj%>">|&nbsp;<%=zj%>&nbsp;|</a>         
<%
...
%> 
                                        ...
                                        <a href="Special-Hosting-Service.asp?page=<%=cstr(pagecount+1)%>"><font color="#ff0000">下一页</font></a><font color="#ff0000"> 
                                        <% end if %>
                                        <% if rs.pagecount>1 and rs.pagecount=pagecount then %>
                                        <a href="Special-Hosting-Service.asp?page=<%=cstr(pagecount-1)%>"> 
                                        上一页</a> 
                                        <%end if%>
                                        <% if pagecount<>1 and rs.pagecount<>pagecount then%>
                                        <a href="Special-Hosting-Service.asp?page=<%=cstr(pagecount-1)%>">上一页</a> 
                                        <a href="Special-Hosting-Service.asp?page=<%=cstr(pagecount+1)%>"><font color="#ff0000">下一页</font></a><font color="#ff0000"> 
                                        <% end if%>											</td>
                                          </tr>
                                        </table>
