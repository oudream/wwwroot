<table width="144" height="170" border="0" cellpadding="0" cellspacing="0">
              <tr valign="top"> 
                <td colspan="2"><p>网站推广知识</p>
      </td>
              </tr>
<%
...
%> 
              <tr> 
                ...
                <td valign="top"><a href="showbase.asp?id=<%=rsnews("id")%>" title="<%=rsnews("subject")%>" target="_blank"> 
...
%>
              <tr> 
                <td>&nbsp;</td>
                <td><div align="right"><a href="viewbase.asp?newstype=网站推广知识" >更多&gt;&gt;</a></div></td>
              </tr>
            </table>