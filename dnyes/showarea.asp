                          ...
                          <TBODY>
                            <TR> 
                              <TD width="34%" vAlign=center style="BORDER-left: #CCCCCC 1px solid; BORDER-RIGHT: #CCCCCC 1px solid; BORDER-BOTTOM: #CCCCCC 1px solid;BORDER-TOP: #CCCCCC 1px solid"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                                  <tr> 
                                    <td background="images/host-2.gif"><img src="images/host-1.gif" width="153" height="25"></td>
                                  </tr>
                                </table>
                                <br> 
                                <br> 
                                <%
sql="select * from subs where area='虚拟主机' order by id" 
Set rs=Server.CreateObject("ADODB.RecordSet") 
rs.open sql,conn,1,1
n=0
'预留分页显示功能
...
%>
                                ...
                                <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                  <tr> 
                                    <td width="120" align="center" valign="top"><img src=showimage.asp?id=<%=rs("id")%>&tu=stu border="0" width="100" height="120"></td>
...
%>
                                ...
                                <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr> 
                                    <td height="20" bgcolor="#f5f5f5"><div align="right">共&nbsp;<%=rscount%>&nbsp;个&nbsp;&nbsp;&lt;&nbsp;<font color=red><%=pagecount%></font>/<%=rs.pagecount%>&nbsp;&gt; 
