...
sql="insert into player (name,uid,pwd,tel,zip,contact,email,nric,ptype,jersey,inserttime,adminlevel) values ('"&uname&"','"&uid&"','"&pwd&"','"&tel&"','"&zip&"','"&contact&"','"&email&"','"&nric&"','"&"a"&"',"&jersey&",'"&now()&"',5)"
conn.Execute(sql)
...
<!------------------------------------------------------------------------------------------------------------------------------------ -->
      ...
      <TR> 
        ...
        <TD><INPUT maxLength=20 size=30 id="uid" name="uid">
          <FONT 
                        face="Verdana, Arial, Helvetica, sans-serif" 
                        color=#000000 size=3> <font color="#FF0000">*</font></FONT> 
        </TD>
      </TR>
      <!---------------------------------------------------------------------------------------------------------------------------------------
<!                     							         PASSWORD
