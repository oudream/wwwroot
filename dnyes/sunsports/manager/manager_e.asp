...
conn.Execute("update player set name='"&uname&"',tel='"&tel&"',zip='"&zip&"',contact='"&contact&"',email='"&email&"',nric='"&nric&"',uid='"&uid&"',pwd='"&pwd&"',jersey="&jersey&" where pid=" & pid)
...
response.Redirect("team_t.asp?option=editmanagerissucc")
