...
<form id="zform" action="player_c.asp" onSubmit="return checkform();" method="post">
  ...
  <table width="100%" border="0" cellspacing="2" cellpadding="2">
    ...
    <tr> 
      <td>&nbsp;</td>
      <td width="22%"><FONT face="Verdana, Arial, Helvetica, sans-serif" 
                  color=#000000 size=3>Score :</FONT><FONT face="Verdana, Arial, Helvetica, sans-serif" 
                  color=#ffffff size=3>&nbsp; </FONT></td>
      <td width="73%"><font face="Verdana, Arial, Helvetica, sans-serif" 
                  color=#ffffff size=3> 
        <input id="default_score"  name="default_score" maxlength=3 size=5>
        </font></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
      <td width="22%"><FONT face="Verdana, Arial, Helvetica, sans-serif" 
                  color=#000000 size=3>Yellow Card :</FONT><FONT face="Verdana, Arial, Helvetica, sans-serif" 
                  color=#ffffff size=3>&nbsp; </FONT></td>
      <td width="73%"><font face="Verdana, Arial, Helvetica, sans-serif" 
                  color=#ffffff size=3> 
        <input id="default_yellow"  name="default_yellow" maxlength=3 size=5>
        </font></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
      <td width="22%"><FONT face="Verdana, Arial, Helvetica, sans-serif" 
                  color=#000000 size=3>Red Card :</FONT><FONT face="Verdana, Arial, Helvetica, sans-serif" 
                  color=#ffffff size=3>&nbsp; </FONT></td>
      <td width="73%"><font face="Verdana, Arial, Helvetica, sans-serif" 
                  color=#ffffff size=3> 
        <input id="default_red"  name="default_red" maxlength=3 size=5>
        </font></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td>&nbsp;</td>
      <td colspan="2">
	  <input type="submit" value="Add" name="option" id="option">
