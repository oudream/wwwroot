...
sql="update team set name='"&zname&"',city='"&zcity&"',telfax='"&ztelfax&"',email='"&zemail&"',homepage='"&zhomepage&"',sponsor='"&zsponsor&"',sponsorhomepage='"&zsponsorhomepage&"',createdate='"&zcreatedate&"',photo='"&zphoto&"',hcolor='"&zhcolor&"',acolor='"&zacolor&"',description='"&zdescription&"' where tid=" & session("manager_tid")
conn.Execute(sql)
  ...
  <table width="100%" border="0" cellspacing="2" cellpadding="2">
    ...
    <tr> 
      ...
      <td width="66%"><font face="Verdana, Arial, Helvetica, sans-serif" 
                  color=#ffffff > 
        <input  name="zname" class="form" id="zname" value="<%=trs("name")%>" size="40" maxlength=100>
