...
%>
  <tr> 
    <td width="67%">
      Order Times: <%=ors("sumcount")%><br>
      Name: <%=rs("name")%><br>
      Price:<font color="#FF0000"> $ <%=rs("price")%></font> 
	</td>
    <td width="33%"><a href="Shopping_ShowProduct.asp?subs_id=<%=rs("subs_id")%>" target="_blank"><img src="<%=rs("pic")%>" width="60" height="60" border="0"></a></td>
  </tr>
  <tr> 
    <td colspan="2">
	           <%
