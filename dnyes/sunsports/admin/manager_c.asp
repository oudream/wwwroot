...
sql="insert into player (name,tel,zip,contact,email,uid,pwd,nric,adminlevel,ptype,jersey,default_score,default_yellow,default_red,inserttime) values ('"&uname&"','"&tel&"','"&zip&"','"&contact&"','"&email&"','"&uid&"','"&pwd&"','"&nric&"',"&adminlevel&",'"&"m"&"',"&jersey&","&default_score&","&default_yellow&","&default_red&",'"&now()&"')"
conn.Execute(sql)
response.Redirect("team_c.asp?option=creammangersucc")
end if
end if
end if
%>
<H2><FONT face="Verdana, Arial, Helvetica, sans-serif" 
                  color=#000066>Create Manager</FONT></H2>
<!----------------------------------------------------------------------------------------------------------------------
<!--                                                   ERROR MSGS
<!-------------------------------------------------------------------------------------------------------------------- -->
<FORM action="manager_c.asp" method="post" name="form_administrator" id="form_administrator" onSubmit="return checkform();">
...
<!------------------------------------------------------------------------------------------------------------------------------------ -->
      ...
      <TR> 
        ...
        <TD><FONT face="Verdana, Arial, Helvetica, sans-serif" 
                        color=#000000 size=3> 
          <input maxlength=3 size=5 id="default_score" name="default_score">
          </FONT></TD>
      </TR>
      <TR> 
        ...
        <TD><FONT face="Verdana, Arial, Helvetica, sans-serif" 
                        color=#000000 size=3> 
          <input maxlength=3 size=5 id="default_yellow" name="default_yellow">
          </FONT></TD>
      </TR>
      <TR> 
        <TD height=43> <DIV align=center><FONT 
        ...
        <TD><FONT face="Verdana, Arial, Helvetica, sans-serif" 
                        color=#000000 size=3> 
          <input maxlength=3 size=5 id="default_red" name="default_red">
          </FONT></TD>
      </TR>
      <TR> 
      ...
      <TR> 
        <TD colSpan=2> <P><FONT face="Verdana, Arial, Helvetica, sans-serif" 
          ...
          <P><STRONG><FONT 
                        face="Verdana, Arial, Helvetica, sans-serif" 
                        color=#000066 size=2>
  			<INPUT name="adminlevel" type=hidden id="adminlevel" value=2>
