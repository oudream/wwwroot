...
url=zurl&"?tid="&tid&"&option=editmanagerasstsucc"
else
...
<H2><FONT face="Verdana, Arial, Helvetica, sans-serif" 
                  color=#000066>Edit Asst.Manager</FONT></H2>
<!----------------------------------------------------------------------------------------------------------------------
<!--                                                   ERROR MSGS
<!-------------------------------------------------------------------------------------------------------------------- -->
<%
...
%>
<FORM action="manager_asst_e.asp" method="post" name="form_administrator" id="form_administrator" onSubmit="return checkform();">
