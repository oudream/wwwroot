...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr> 
    ...
    <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr> 
          <td height="30" align="center" valign="middle"><strong> Match Final 
            Result </strong></td>
        </tr>
      </table></td>
    <td>&nbsp;</td>
              ...
              <table width="100%" border="0" cellspacing="2" cellpadding="2">
                <tr align="center" valign="middle"> 
                  <td height="30" colspan="3"><table width="100%" border="0" cellspacing="2" cellpadding="2">
                      <tr> 
                        <td width="33%"><font color="#FF0000">STEP 1 ( FINAL RESULT 
                          FILL )</font></td>
                ...
                <tr> 
                  <td width="51%"><%=mrs("htname")%> <font color="#FF0000"> VS </font> <%=mrs("atname")%></td>
                  <td width="46%"><input name="oufinalh" type="text" id="oufinalh" size="5" maxlength="2" value=<%=oufinalh%>> 
                    &nbsp;<strong> : </strong>&nbsp; 
                    <input name="oufinala" type="text" id="oufinala" size="5" maxlength="2" value=<%=oufinala%>>
                  </td>
                  <td width="3%">&nbsp;</td>
                </tr>
                <tr> 
...
%>
                <tr> 
				  ...
				  <select name="<%="hspid"&cstr(i)%>" id="<%="hspid"&cstr(i)%>">
                      <%
...
%>					  
                    ...
                    -Card </td>
                  <td>
                    <input name="<%="hd"&cstr(i)%>" type="text" id="<%="hd"&cstr(i)%>" size="5" maxlength="2" value=<%=adi(i)%>>
                    -NUM</td>
                </tr>
<%
else
...
%>
                  ...
                  <td><select name="<%="hc"&cstr(i)%>" id="<%="hc"&cstr(i)%>">
                    ...
                    -Card </td>
                  <td>
                    <input name="<%="hd"&cstr(i)%>" type="text" id="<%="hd"&cstr(i)%>" size="5" maxlength="2">
                    -NUM</td>
                </tr>
<%
end if
