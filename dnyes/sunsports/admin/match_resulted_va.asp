...
%>
  <table width="100%" border="0" cellspacing="2" cellpadding="2">
    ...
    <tr> 
      <td>&nbsp;</td>
      <td><table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
          <tr bgcolor="#FFFFFF"> 
...
%>
    ...
    <tr> 
      ...
      <td> 
        ...
        <tr bgcolor="#FFFFFF"> 
          <td width="305" height="25"><b><strong><a href="match_r_vedit.asp">The 
            Home Match Result Is OK</a></strong></b></td>
          <td width="36">&nbsp;</td>
          <td width="245"><b><a href="match_r_c2.asp?option=deledit&mid=<%=mmid%>&htid=<%=htid%>&atid=<%=atid%>">Edit 
            it and Add</a></b></td>
          <td width="186">&nbsp;</td>
          <td width="189">&nbsp;</td>
        </tr>
