  ...
  <tr> 
    <td> <%if session("y_it_uid")<>"" then%> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20"> <div align="center">→</div></td>
          <td width="108"><a href="viewmyorders.asp">查看订单</a></td>
          <td width="108"><a href="paysuccemailtome.asp">付款确认</a></td>
        </tr>
        <tr> 
          <td height="20"> <div align="center">→</div></td>
        ...
        <tr> 
          <td height="20"> <div align="center">→</div></td>
          <td><a href="domainmanage.asp" target="_blank">域名管理</a></td>
        ...
        <form action="login.asp" method="post" name="login" onSubmit="return checkform();">
          <tr> 
            <td height="22" align="center"> 会员： 
              <input maxlength=20 name=uid size=16 class="input"> </td>
          </tr>
          <tr> 
            <td height="32" align="center"> 密码： 
              <input maxlength=20 name=pwd size=16 type=password class="input"> 
            </td>
          </tr>
          <tr align="center"> 
            <td> <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr> 
                  <td height="19" align="center"> <input type="hidden" name="url" value=<%=url%>> 
                    <input class="inputfield" type="image" border="0" name="imageField2" src="images/login.gif" width="64" height="19"> 
