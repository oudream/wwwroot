                      ...
                      <td background="images/left-228x5.gif"><TABLE width=70% border=0 cellPadding=0 cellSpacing=0>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                          <tr> 
                            ...
                            <td height="20" colspan="2">1.选择您需要的套餐类型</td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td height="20" colspan="2">4.提交购买套餐的订单</td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td>&nbsp;</td>
                            <td width="199" height="20" align="right">更多&gt;&gt;</td>
                            <td width="17">&nbsp;</td>
                          </tr>
                        </table>
                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td background="images/left-228x5.gif">
                        <!--#include file="faqfavorables.asp" -->
                      </td>
                    </tr>
                  </table>
                  <TABLE width=100% border=0 cellPadding=0 cellSpacing=0 bgcolor="#FFFFFF">
                          ...
                          <TBODY>
                            <TR> 
                              <TD width="34%" vAlign=center style="BORDER-left: #CCCCCC 1px solid; BORDER-RIGHT: #CCCCCC 1px solid; BORDER-BOTTOM: #CCCCCC 1px solid;BORDER-TOP: #CCCCCC 1px solid"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                                  <tr> 
                                    <td background="images/host-2.gif"><img src="images/pro_taoc.GIF" width="153" height="25"></td>
                                  </tr>
                                </table>
                                <br> 
                                <br> 
...
%> 
   <a href="china-favorables.asp?page=<%=zj%>">|&nbsp;<%=zj%>&nbsp;|</a>         
<%
...
%> 
                                        ...
                                        <a href="china-favorables.asp?page=<%=cstr(pagecount+1)%>"><font color="#ff0000">下一页</font></a><font color="#ff0000"> 
                                        <% end if %>
                                        <% if rs.pagecount>1 and rs.pagecount=pagecount then %>
                                        <a href="china-favorables.asp?page=<%=cstr(pagecount-1)%>"> 
                                        上一页</a> 
                                        <%end if%>
                                        <% if pagecount<>1 and rs.pagecount<>pagecount then%>
                                        <a href="china-favorables.asp?page=<%=cstr(pagecount-1)%>">上一页</a> 
                                        <a href="china-favorables.asp?page=<%=cstr(pagecount+1)%>"><font color="#ff0000">下一页</font></a><font color="#ff0000"> 
                                        <% end if%>											</td>
                                          </tr>
                                        </table>
