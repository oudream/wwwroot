...
%>
              ...
              <tr> 
                ...
                <td>&nbsp; <div align="right">共&nbsp;<%=amount%>&nbsp;个&nbsp;&nbsp;每页&nbsp;20&nbsp;个&nbsp;&nbsp;<font color=red><%=pagecount%></font>/<%=rsnews.pagecount%> 
                    ...
                    <a href="viewfaqbase.asp?newstype=<%=zname%>&page=<%=cstr(pagecount+1)%>"><font color="#ff0000">下一页</font></a><font color="#ff0000"> 
                    <% end if %>
                    ...
                    <a href="viewfaqbase.asp?newstype=<%=zname%>&page=<%=cstr(pagecount-1)%>">上一页</a> 
                    <a href="viewfaqbase.asp?newstype=<%=zname%>&page=<%=cstr(pagecount+1)%>"><font color="#ff0000">下一页</font></a><font color="#ff0000"> 
                    <% end if%>
                    &nbsp;</font></font></div></td>
              </tr>
