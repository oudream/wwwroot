...
%>
  <tr> 
    ...
    <td><a href="<%=rsnews("addr")%>" title="<%=rsnews("subject")%>" target="_blank"> 
                  <font color=<%=rsnews("color")%>><% if len(rsnews("subject"))>16 then%> <%=left(rsnews("subject"),15)%>..<%else%> 
...
%>
  <tr> 
    <td colspan="2"><div align="right"><a href="viewdocument2.asp" >¸ü¶à&gt;&gt;</a></div></td>
  </tr>
</table>
<TABLE width=70% border=0 cellPadding=0 cellSpacing=0>
  <TBODY>
