...
response.redirect "error.asp?err=014&zurl=viewmyorders.asp"
response.end
end if
%>
<html>
                        ...
                        <TD width="34%" vAlign=center style="BORDER-left: #CCCCCC 1px solid; BORDER-RIGHT: #CCCCCC 1px solid; BORDER-BOTTOM: #CCCCCC 1px solid;BORDER-TOP: #CCCCCC 1px solid"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <table width="498" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
                            <tr bgcolor="#9CCCFF"> 
                              ...
                              <td align="center" bgcolor="#f5f5f5">订单号</td>
                              <td align="center" bgcolor="#f5f5f5">支付金额</td>
                              <td align="center" bgcolor="#f5f5f5">商品名称</td>
...
%>
                            ...
                            <tr bgcolor="#FFFFFF"> 
                              ...
                              <td align="center"><%=rs("xiangxi")%></td>
                              <td align="center"><%=rs("ordertime")%></td>
                              <td align="center">[<a href="viewmyorders-1.asp?id=<%=rs("id")%>" target="_blank">详情</a>]</td>
                            ...
                            <tr bgcolor="#FFFFFF"> 
                              <form action="viewmyorders.asp" method="post">
                                <td height="35" colspan="9"> <div align="center"> 
                                    共 <b><%=rs.recordcount%></b> 张订单,页次: <b><font color=red><%=pagecount%></font>/<%=rs.pagecount%></b>, 当前从第 
                                    <%
if pagecount<=1 then
...
%>
                                    ...
                                    <a href="viewmyorders.asp?page=<%=cstr(pagecount+1)%>"> 
                                    下一页</a> 
                                    <% end if %>
                                    ...
                                    <a href="viewmyorders.asp?page=<%=cstr(pagecount-1)%>"> 
                                    上一页</a> <a href="viewmyorders.asp?page=<%=cstr(pagecount+1)%>"> 
                                    下一页</a> 
                                    <% end if%>
                                    &nbsp; 直接到第 
                                    <select name="page">
