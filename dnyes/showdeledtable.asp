...
<%
id=request("id")
sql="select * from deleddomain where id="&id
Set rs=Server.CreateObject("ADODB.RecordSet") 
rs.open sql,conn,1,1
deleddomain=rs("deleddomain")
deledtable=rs("deledtable")
deleddate=rs("deleddate")
rs.close
set rs=nothing
%>
<html>
          ...
          <td width="513" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td height="25"><p
                  ...
                  <div align="center"><b>=== <%=deledtable%> ===</b><br>
                  </div>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        ...
                        <td> <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                            <tr>
                              <td width="264" colspan="2" align="center"> &nbsp;&nbsp;相关 .com</td>
                              <td width="265" align="center">相关 .net 和 .org</td>
                            </tr>
                            <tr>
                              <td width="264" height="20" colspan="2">&nbsp;</td>
                              <td width="265" height="20">&nbsp;</td>
                            </tr>
                            <tr> 
                              <td width="264" colspan="2" align="center" valign="top"> <%
deleddomain=split(deleddomain,"(DELETED TODAY)")
for i=0 to ubound(deleddomain)
%> <%
if Instr(1,trim(deleddomain(i)),".com",1)<>0 then
%> &nbsp; <%=deleddomain(i)%><br> <%
end if
next
%> </td>
...
%> </td>
                      ...
                      <tr>
                        <td height="200" align="right" valign="bottom">
 						<!--#include file="windeleddomain.asp" --> 
 						</td>
                      </tr>
                      <tr> 
                        <td height="20">&nbsp; <div align="right"><%=Application("y_it_itname")%>&nbsp;&nbsp;<%=deleddate%>&nbsp;&nbsp;&nbsp;</div></td>
                      </tr>
                      <tr> 
