...
function gettarg(targ,selObj,restore){ 
  eval(targ+".location='subs_select_in8.asp?option="+'取消选择'+"&sort_id="+selObj.options[selObj.selectedIndex].value+"'");
  if (restore) selObj.selectedIndex=0;
}
function getbrand(targ,selObj,restore,sort_id){ 
  eval(targ+".location='subs_select_in8.asp?option="+'取消选择'+"&sort_id="+sort_id+"&brand_id="+selObj.options[selObj.selectedIndex].value+"'");
  if (restore) selObj.selectedIndex=0;
}
function getsubs(targ,selObj,restore,sort_id,brand_id){ 
  eval(targ+".location='subs_select_in8.asp?option="+'取消选择'+"&sort_id="+sort_id+"&subs_id="+selObj.options[selObj.selectedIndex].value+"&brand_id="+brand_id+"'");
  if (restore) selObj.selectedIndex=0;
}
function checkform()
{
...
%>
<form name="form_administrator" method="post" action="subs_select_in8.asp" onSubmit="return checkform();">
