...
<%
sql="select * from guest order by allname,simname" 
...
%>
                <td width="50"><a href="guest_view.asp?page=<%=zj%>">&nbsp;<%=zj%>&nbsp;</a></td>
                <%
zj=zj+1
next
%>
  ...
  <tr> 
    ...
    <td width="60" bgcolor="#FFFFFF">简称</td>
...
%>
  <tr> 
    ...
    <td bgcolor="#FFFFFF"><a href="guest_edit.asp?gid=<%=rs("gid")%>"><%=rs("simname")%></a>&nbsp;</td>
