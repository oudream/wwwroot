...
filename1=year(now)&month(now)&day(now)&hour(now)&minute(now)&second(now)&ranNum&"."&fileExt	
           ...
           set rs=nothing
			msg="上传文件成功！"
 	  		strJS=strJS & "content=parent.document.media.w.value;"
			...
			select case FileType
				...
				case "mht"
					...
					case "avi","wmv","asf","wma"
					strJS=strJS & "content=content+'" & filename & "';" & vbcrlf
				
	  			end select
	  			strJS=strJS & "parent.document.media.w.value=content;" & vbcrlf
	  		strJS=strJS & "content=parent.document.media.h.value;"
 	  				FileType=right(fileExt,3)
			select case FileType
			    case "jpg","gif","png","bmp"
				...
				case "mht"
	  			...
	  			strJS=strJS & "parent.document.media.h.value=content;" & vbcrlf
	
		end if
		strJS=strJS & "alert('" & msg & "');" & vbcrlf
	  	strJS=strJS & "window.location = 'upme5.htm';" & vbcrlf
	  	strJS=strJS & "</script>"
