...
<table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bordercolor="#CCCCCC">
  <tr align="center" bgcolor="#FFFFFF"> 
    <td height="22" colspan="9"><font color="#FF0000"><strong>备忘列表</strong></font></td>
  </tr>
  <tr align="center" bgcolor="#FFFFFF"> 
  ...
  <tr> 
    ...
    <td width="120" align="center" bgcolor="#FFFFFF">备忘用户</td>
    <td width="150" align="center" bgcolor="#FFFFFF">备忘时间</td>
    <td align="center" bgcolor="#FFFFFF">备忘</td>
...
%> 
    ...
    <td align="center" bgcolor="#FFFFFF"><a href="art_note_all.asp????">查看</a> 
      | <a href="art_note_edit.asp?zid=<%=rs("id")%>">编辑</a> | <a href="art_note_del.asp?????">删除</a></td>
  </tr>
  <%
rs.movenext
i=i+1                                                                     
...
%>
  <tr align="center" bgcolor="#FFFFFF"> 
    <td height="35" colspan="9"><font size="4"><strong><a href="art_note_add.asp">备忘添加</a></strong></font></td>
  </tr>
</table>
...
%>
          <td><a href="art_note_view.asp?page=<%=zj%>">&nbsp;<%=zj%>&nbsp;</a></td>
          <%
zj=zj+1
next
%>
