            ...
            <td width="50%">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td width="92%">
                  	<input type="radio" value="pixels" name="widthtype">像素&nbsp;&nbsp;
										<input type="radio" value="percentage" checked name="widthtype">百分比
                  </td>
                </tr>
              </table>
            </td>
                ...
                <tr>
                  ...
                  <td width="29%"> 
                    <table id=bordercolortable cellspacing=0 cellpadding=0 border=0>
                      <tbody> 
                      <tr> 
                        <td onClick=showCol(1); width="100%"><img height=20 src="images/clrbox.gif" width=54 
              border=0></td>
                      </tr>
                      </tbody>
                    </table>
