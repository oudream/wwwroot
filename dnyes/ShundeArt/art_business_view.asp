...
conn.execute "delete * from art_business where art_business_id=" & request("art_business_id")
...
<form name="form_administrator" id="form_administrator" method="post" action="art_business_view.asp">
...
sql="select * from art_business where allname<>'' " 
...
sql = sql &" order by art_business_id DESC"
...
<table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bordercolor="#CCCCCC">
  <tr bgcolor="#FFFFFF"> 
    <td height="30" colspan="8" align="center" class="header"><font color="#FF0000" size="+1"><strong>企业列表</strong></font></td>
  </tr>
  <tr align="center"> 
    <td width="126" height="30" bgcolor="#FFFFFF">全称</td>
    <td width="95" bgcolor="#FFFFFF">地址</td>
    <td width="156" bgcolor="#FFFFFF">电话</td>
    <td width="233" bgcolor="#FFFFFF">传真</td>
    <td width="126" bgcolor="#FFFFFF">法定代理人</td>
    <td width="256" bgcolor="#FFFFFF">操作</td>
  </tr>
  <%
do while not rs.eof 
%>
  <tr align="center"> 
    ...
    <td bgcolor="#FFFFFF"><a href="art_business_viewall.asp?art_business_id=<%=rs("art_business_id")%>" target="_blank">详细</a>&nbsp; | &nbsp;<a href="art_business_edit.asp?art_business_id=<%=rs("art_business_id")%>">编辑</a>&nbsp; | &nbsp;<a href="art_business_view.asp?art_business_id=<%=rs("art_business_id")%>&option=del" onClick="return confirm('确定删除此项吗？')">删除</a>&nbsp;</td>
  </tr>
  <%
rs.movenext
i=i+1                                                                     
...
if zj<=zk*15 then
%>
          <td><a href="art_business_view.asp?zname=<%=zname%>&zaddr=<%=zaddr%>&ztel=<%=ztel%>&zfax=<%=zfax%>&zcap=<%=zcap%>&zothers=<%=zothers%>&page=<%=zj%>">&nbsp;<%=zj%>&nbsp;</a></td>
          <%
else
zk=zk+1
%>
