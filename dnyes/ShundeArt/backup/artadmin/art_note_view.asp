...
sql="select * from art_note order by id desc" 
...
%>
                <td width="50"><a href="art_note_view.asp?page=<%=zj%>">&nbsp;<%=zj%>&nbsp;</a></td>
                <%
zj=zj+1
next
%>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="34%" align="right"><font size="4"><strong><a href="art_note_add.asp">备忘添加</a></strong></font></td>
        </tr>
      </table></td>
  </tr>
  <tr> 
...
%>
  <tr> 
    <td width="130" align="center" bgcolor="#FFFFFF"><a href="art_note_edit.asp?zid=<%=rs("id")%>"><%=rs("subject")%></a>&nbsp;</td>
...
%>
  <tr align="center" bgcolor="#FFFFFF"> 
    <td height="35" colspan="8"><font size="4"><strong><a href="art_note_add.asp">备忘添加</a></strong></font></td>
  </tr>
</table>
<%
rs.close
