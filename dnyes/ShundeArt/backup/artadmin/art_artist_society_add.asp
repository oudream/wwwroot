...
if cap="" then cap=" "
if memo="" then memo=" "
sql="insert into art_collecter_society (allname,addr,tel,fax,zip,email,web_addr,creation_date,cap,memo,inserttime) values ('"&allname&"','"&addr&"','"&tel&"','"&fax&"','"&zip&"','"&email&"','"&web_addr&"','"&creation_date&"','"&cap&"','"&memo&"','"&now()&"')"
conn.Execute(sql)
