...
<%
sql="select * from art_collecter_society order by allname" 
...
%>
                <td width="50"><a href="art_collecter_society_view.asp?page=<%=zj%>">&nbsp;<%=zj%>&nbsp;</a></td>
                <%
zj=zj+1
next
%>
...
%>
  <tr> 
    <td height="25" bgcolor="#FFFFFF"><a href="art_collecter_society_edit.asp?art_collecter_society_id=<%=rs("art_collecter_society_id")%>"><%=rs("allname")%></a>&nbsp;</td>
