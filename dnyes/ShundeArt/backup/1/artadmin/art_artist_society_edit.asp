...
if memo="" then memo=" "
conn.Execute("update art_collecter_society set allname='"&allname&"',addr='"&addr&"',tel='"&tel&"',fax='"&fax&"',zip='"&zip&"',email='"&email&"',web_addr='"&web_addr&"',creation_date='"&creation_date&"',cap='"&cap&"',memo='"&memo&"' where art_collecter_society_id=" & request("art_collecter_society_id"))
