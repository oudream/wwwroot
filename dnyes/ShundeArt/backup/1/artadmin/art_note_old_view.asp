...
%>
                <td width="50"><a href="art_note_old_view.asp?page=<%=zj%>">&nbsp;<%=zj%>&nbsp;</a></td>
                <%
zj=zj+1
next
%>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="66%"><strong><font size="5">纪事列表 </font></strong></td>
          <td width="34%" align="right"><font size="4"><strong><a href="art_note_old_add.asp">纪事添加</a></strong></font></td>
        </tr>
      </table></td>
  </tr>
  <tr> 
    <td width="130" align="center" bgcolor="#FFFFFF">纪事时间</td>
    <td width="320" align="center" bgcolor="#FFFFFF">纪事</td>
  </tr>
  <%
...
%>
  <tr> 
    <td width="130" align="center" bgcolor="#FFFFFF"><a href="art_note_old_edit.asp?zid=<%=rs("id")%>"><%=rs("note_time")%></a>&nbsp;</td>
