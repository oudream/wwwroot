...
<%
sql="select * from art_museum order by artname" 
Set rs=Server.CreateObject("ADODB.RecordSet") 
rs.open sql,conn,1,1 

if rs.eof or rs.bof then 
response.Write("<SCRIPT LANGUAGE=JavaScript> alert(' 暂时没有数据! ');</SCRIPT>")
response.End()
end if
...
%>
                <td width="50"><a href="art_museum_view.asp?page=<%=zj%>">&nbsp;<%=zj%>&nbsp;</a></td>
                <%
zj=zj+1
next
%>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" colspan="8" align="center" class="header">中国博物馆列表</td>
  </tr>
  <tr> 
    <td width="80" height="30" bgcolor="#FFFFFF">名称</td>
    <td width="60" bgcolor="#FFFFFF">地址</td>
    <td width="100" bgcolor="#FFFFFF">电话</td>
    <td width="150" bgcolor="#FFFFFF">传真</td>
    <td width="80" bgcolor="#FFFFFF">网址</td>
    <td width="150" bgcolor="#FFFFFF">负责人</td>
  </tr>
  <%
do while not rs.eof 
%>
  <tr> 
    <td height="25" bgcolor="#FFFFFF"><a href="art_museum_edit.asp?id=<%=rs("art_museum_id")%>"><%=rs("artname")%></a>&nbsp;</td>
