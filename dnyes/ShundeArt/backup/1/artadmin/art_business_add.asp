...
if memo="" then memo=" "
sql="insert into art_business (allname,addr,tel,fax,zip,email,web_addr,legal_representative,memo,inserttime) values ('"&allname&"','"&addr&"','"&tel&"','"&fax&"','"&zip&"','"&email&"','"&web_addr&"','"&legal_representative&"','"&memo&"','"&now()&"')"
conn.Execute(sql)
  ...
  <TABLE height=307 cellSpacing=0 cellPadding=0 width=550 
    ...
    <TBODY>
      ...
      <TR> 
        <TD width=120 height=45> <DIV align=center><FONT 
                        face="Verdana, Arial, Helvetica, sans-serif" 
                        color=#000000 >法定代理人</FONT></DIV></TD>
        <TD width=396><FONT 
                        face="Verdana, Arial, Helvetica, sans-serif" 
                        color=#000000 > 
          <INPUT maxLength=40 size=30 id="concacter" name="legal_representative">
          </FONT></TD>
      </TR>
      <TR> 
        <TD height=32> <DIV align=center><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif">简介</font></DIV></TD>
