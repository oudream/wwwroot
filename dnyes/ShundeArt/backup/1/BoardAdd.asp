...
<title><%=copyright%><%=version%>&nbsp;<%=ver%> - 添加公告</title>
...
<form method="POST" action="BoardSave.asp" OnSubmit="return checkdata()" onReset="return ResetForm();" name="form1">
<tr class="TDtop">
	<td width="100%" height="25" colspan=2 align=center>┊ <strong>添 加 公 告</strong> ┊</td>
</tr>
<tr> 
	<td width="74" align="right" class="unnamed2" valign="middle" bgcolor="#FFFFFF">公告标题：</td>
	<td width="685" bgcolor="#FFFFFF">&nbsp;
		<input name="title" id=me type="TEXT" size=60 maxlength=20 onMouseOver="window.status='在这里输入要添加的公告标题，必填';return true;" onMouseOut="window.status='';return true;" title='在这里输入要添加的公告标题，必填' style="font-size: 9pt;  color: #000000; background-color: #EAEAF4; solid #EAEAF4" onMouseOver ="this.style.backgroundColor='#ffffff'" onMouseOut ="this.style.backgroundColor='#EAEAF4'">
...
<tr> 
	...
	<img class=None onmousedown="Check(this,2)" onmouseover="Check(this,1)" onmouseout="Check(this,0)" onmouseup="Check(this,1)" src="images/link.gif" align="absmiddle" border="0" alt="超级链接" onClick="FormatText('createLink')" style="cursor: hand;">
		...
		<script language="javascript">
			document.write ('<iframe src="boardtextbox.asp?action=new" id="message" width="650" height="300" align=center></iframe>')
...
<tr class="TDtop" align="center"> 
	<td colspan="2" height="25">
		...
		<input type="submit" value=" 添 加 " name="Submit" class="unnamed5" OnClick="document.form1.Content.value =frames.message.document.body.innerHTML;" style="font-size: 9pt;  color: #000000; background-color: #EAEAF4; solid #EAEAF4" onMouseOver ="this.style.backgroundColor='#ffffff'" onMouseOut ="this.style.backgroundColor='#EAEAF4'">&nbsp;
		<input type="reset" value=" 重 置 " name="Reset" class="unnamed5" style="font-size: 9pt;  color: #000000; background-color: #EAEAF4; solid #EAEAF4" onMouseOver ="this.style.backgroundColor='#ffffff'" onMouseOut ="this.style.backgroundColor='#EAEAF4'">
