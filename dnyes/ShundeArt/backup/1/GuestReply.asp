	...
	<td>
		...
		<tr> 
			<td valign="top">
				...
				<tr> 
					<td width="100%" height="25" background="images/menu-guestbook.gif" bgcolor="CDCCCC" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;栏目导航&nbsp;&nbsp;<a class=daohang href="./" >网站首页</a>&gt;&gt;<a href="GuestBook.asp" class="daohang">雁过留声</a>&gt;&gt;回复留言</td>
				</tr>
				</table>
			</td>
		</tr>
		...
		<tr> 
			<td height="85" background="images/menu-guest-l.gif"> 
				<table cellpadding=3 cellspacing=1 border=0 width=100%>
				<tr> 
					<td width="20%" height="22" align="right" valign="top"> &nbsp;回复内容：</td>
					<td width="70%" height="22">&nbsp; 
						...
						<img class=None src="images/help.gif" align="absmiddle" border="0" style="cursor:hand;" alt="使用帮助" lANGUAGE="javascript" onclick="help()"> 
						<a href=javascript:about()><img class=None src="images/about.gif" align="absmiddle" border="0" style="cursor:hand;" alt="关于本系统"></a><br><br> 
						<font color="#FF0000">*</font>
						<script language="javascript">
							document.write ('<iframe src="guestbox.asp?action=new" id="message" width="550" height="200" align=center></iframe>')
		...
		<tr> 
			<td height="25" background="images/menu-guest-l.gif">&nbsp;</td>
		</tr>
		</table>
	</td>
</tr>
...
<tr> 
	<td height="25" align="center" background="images/menu-guest-l.gif"> 
		...
		<input name="button" type="submit" value=" 回 复 " name="reply" onClick="document.form1.guestreply.value = frames.message.document.body.innerHTML;">&nbsp;&nbsp;
		<input type="reset" value=" 清 除 " name="Reset">
		<input type="hidden" name="guestreply" value=""> 
		<input type="hidden" name="reviewid" value="<%=cint(request("reviewid"))%>"> 
	</td>
</tr>
<tr>
