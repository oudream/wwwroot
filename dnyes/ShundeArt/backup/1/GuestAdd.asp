...
<form action=GuestSave.asp method=post name=form1 OnSubmit="return checkdata()" onReset="return ResetForm();">
  <table width="760" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr valign="top"> 
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td height="3" valign="top" bgcolor="#FFFFFF"> 
              <div align="center"><img src="IMAGES/kb.gif" width="9" height="3"></div></td>
          </tr>
          <tr> 
            <td valign="top"> <table width="102%" border="0" cellspacing="0" cellpadding="0">
                <tr bgcolor="CDCCCC"> 
                  <td width="100%" height="25" background="IMAGES/menu-guestbook.gif" bgcolor="CDCCCC">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;栏目导航&nbsp;&nbsp;<a class=daohang href="./" >网站首页</a>&gt;&gt;<a href="guestbook.asp" class="daohang">雁过留声</a>&gt;&gt;<strong>书写留言</strong></td>
                </tr>
                <tr> 
                  <td valign="top" background="IMAGES/menu-guest-l.gif" bgcolor="#FFFFFF"><div align="center"><a class=daohang href="./" >
                      </a><a class=daohang href="./" >
                      <script language=javascript src=./zongg/ad.asp?i=13></script>
                      </a> </div></td>
                </tr>
                <tr bgcolor="CDCCCC"> 
                  <td height="25" align="center" background="IMAGES/menu-l-guest.gif" bgcolor="CDCCCC"><font color="#000000">发表留言(有<font color="#FF0000">*</font>号的必填)</font></td>
                </tr>
              </table></td>
          </tr>
        </table></td>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr> 
            <td background="IMAGES/menu-guest-l.gif"><div align="center">
                <table width=95% border=0 cellpadding=3 cellspacing=1>
                  <tr> 
                    <td width="15%" height="22" align="right"> <font color="#FF0000">*</font>&nbsp;用户名：</td>
                    <td width="70%" height="22"> 
                      <input type="text" name="guestname" maxlength="10" size="10" style="font-family: 宋体; font-size: 9pt;" <%if request.cookies(Forcast_SN)("username")<>"" then%>value="<%=request.cookies(Forcast_SN)("username")%>" readonly<%end if%>>
                    </td>
                  </tr>
                  <tr> 
                    <td width="15%" height="22" align="right"> &nbsp;密码：</td>
                    <td width="70%" height="22"> 
                      <input type="password" name="password" size="10" style="font-family: 宋体; font-size: 9pt;">
                      如果您是本站注册会员，请输入您的密码</td>
                  </tr>
                  <tr> 
                    <td width="15%" align="right" height="22"> &nbsp;身份：</td>
                    <td width="70%" height="22"> <font color="#FF0000">
<select size="1" name="shengfen" style="font-family: 宋体; font-size: 9pt;">
                  ...
                  <tr> 
                    ...
                    <td width="70%" height="22">
<input type="text" name="from" maxlength="10" size="10" style="font-family: 宋体; font-size: 9pt;"> 
                    </td>
                  </tr>
                  <tr> 
                    <td width="15%" height="22" align="right"> &nbsp;e-mail地址：</td>
                    <td width="70%" height="22"> 
                      <input type="text" name="email" style="font-family: 宋体; font-size: 9pt;" size="20">
                      如果留空，默认为您注册时使用的E-mail地址。</td>
                  </tr>
                  <tr> 
                    <td width="15%" height="22" align="right"> &nbsp;主页地址：</td>
                    <td width="70%" height="22"> 
                      <input type="text" name="homepage" style="font-family: 宋体; font-size: 9pt;" size="20"> 
                    </td>
                  </tr>
                  <tr> 
                    <td width="15%" height="22" align="right"> &nbsp;oicq：</td>
                    <td width="70%" height="22"> 
                      <input type="text" name="oicq" maxlength="10" style="font-family: 宋体; font-size: 9pt;" size="20"> 
                    </td>
                  </tr>
                  <tr> 
                    <td width="15%" height="39" align="right" valign="top"> <br>
                      &nbsp;<font color="#FF0000">*</font>头像：</td>
                    <td width="70%" height="39"> <br> 
                      <% for i=1 to 7 %>
                      <img src="images/image<%=i%>.GIF" align="absmiddle" width="45" height="45"> <input type="radio" name="face" value='images/Image<%=i%>.gif'> 
                      <%next%>
                      <br>
                      <br> 
                      <% for i=8 to 14 %>
                  ...
                  <tr> 
                    <td width="15%" height="22" align="right" valign="top"> <br>
                      &nbsp;<font color="#FF0000">*</font>留言内容：</td>
                    <td width="70%" height="22"> <p><br>
                      ...
                      <p> 
	<script language="javascript">
		document.write ('<iframe src="guestbox.asp?action=new" id="message" width="500" height="200" align=left></iframe>')
  ...
  <table width="760" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="759BAC">
	<tr> 
		<td height="25" align="center" background="IMAGES/menu-guest-l.gif">以上内容仅写给管理员（悄悄话）：&nbsp;&nbsp;
			<input type="radio" name="qqh" value=-1>是&nbsp;&nbsp;
			<input type="radio" name="qqh" checked value=0>否<br><br>
		</td>
	</tr>
	<tr> 
		<td height="25" align="center" background="IMAGES/menu-guest-l.gif"> 
