...
if not(request.cookies(Forcast_SN)("ManageKEY")="super" or request.cookies(Forcast_SN)("ManageKEY")="bigmaster" or request.cookies(Forcast_SN)("ManageKEY")="check" or request.cookies(Forcast_SN)("ManageKEY")="typemaster") then
	...
	sql1="select * from "& db_board_Table &" where id="&request("id")
...
<tr class="TDtop">
	<td width="100%" height="25" colspan=2 align=center>┊ <strong>修 改 公 告</strong> ┊</td>
</tr>
<tr> 
	<td width="74" align="right" class="unnamed2" valign="middle" bgcolor="#FFFFFF">公告标题：</td>
	<td width="685" bgcolor="#FFFFFF">&nbsp;
		<input name="title" value="<%=rs1("title")%>" id=me type="TEXT" size=60 maxlength=20 onMouseOver="window.status='在这里输入要添加的公告标题，必填';return true;" onMouseOut="window.status='';return true;" title='在这里输入要添加的公告标题，必填'  style="font-size: 9pt;  color: #000000; background-color: #EAEAF4; solid #EAEAF4" onMouseOver ="this.style.backgroundColor='#ffffff'" onMouseOut ="this.style.backgroundColor='#EAEAF4'">
		<font color="#FF0000">*</font>最多20个中文或20个英文
	</td>
</tr>
<tr>
	<td width="74" align="right" valign="top" class="unnamed2" bgcolor="#FFFFFF">公告内容：<br><font color="#FF0000">*</font>&nbsp;</td>
	<td width="685" bgcolor="#FFFFFF">&nbsp;&nbsp;
		<select name="selectFont" onChange="FormatText('fontname', selectFont.options[selectFont.selectedIndex].value);document.form1.selectFont.options[0].selected = true;"  style="font-family: 宋体; font-size: 9pt" onMouseOver="window.status='选择选定文字的字体。';return true;" onMouseOut="window.status='';return true;" style="font-size: 9pt;  color: #000000; background-color: #EAEAF4; solid #EAEAF4" onMouseOver ="this.style.backgroundColor='#ffffff'" onMouseOut ="this.style.backgroundColor='#EAEAF4'">
		...
		<select name="selectColour" onChange="FormatText('ForeColor',selectColour.options[selectColour.selectedIndex].value);document.form1.selectColour.options[0].selected = true;" onMouseOver="window.status='选择选定文字的颜色。';return true;" onMouseOut="window.status='';return true;" style="font-size: 9pt;  color: #000000; background-color: #EAEAF4; solid #EAEAF4" onMouseOver ="this.style.backgroundColor='#ffffff'" onMouseOut ="this.style.backgroundColor='#EAEAF4'">
			<option value="0" selected>选择颜色</option>
		...
		<select name="selectbgColour" onChange="FormatText('BackColor',selectbgColour.options[selectbgColour.selectedIndex].value);document.form1.selectbgColour.options[0].selected = true;" onMouseOver="window.status='选择选定文字的背景颜色。';return true;" onMouseOut="window.status='';return true;" style="font-size: 9pt;  color: #000000; background-color: #EAEAF4; solid #EAEAF4" onMouseOver ="this.style.backgroundColor='#ffffff'" onMouseOut ="this.style.backgroundColor='#EAEAF4'">
		...
		<select language="javascript"  id="FontSize" title="字号大小" onChange="FormatText('fontsize',this[this.selectedIndex].value);" name="select" onMouseOver="window.status='选择选定文字的字号大小。';return true;" onMouseOut="window.status='';return true;" style="font-size: 9pt;  color: #000000; background-color: #EAEAF4; solid #EAEAF4" onMouseOver ="this.style.backgroundColor='#ffffff'" onMouseOut ="this.style.backgroundColor='#EAEAF4'">
		...
		<input onClick="setMode(this.checked);" name=viewhtml type="checkbox" value="ON">查看HTML源代码<br>&nbsp;&nbsp;<img class=None onmousedown="Check(this,2)" onmouseover="Check(this,1)" onmouseout="Check(this,0)" onmouseup="Check(this,1)" src="images/selectall.gif" align="absmiddle" border="0" alt="全部选择" onClick="FormatText('selectall')" style="cursor: hand;">
		...
		<script language="javascript">
			document.write ('<iframe src="boardtextbox.asp?action=modify&id=<%=request("id")%>" id="message" width="650" height="300" align=center></iframe>')
...
<tr class="TDtop" align="center"> 
	<td colspan="2" height="25">
		<input name="upload" type="hidden" value="<%=request.cookies(Forcast_SN)("username")%>">
		<input type="button" value=" 返 回 " onclick="javascript:history.go(-1)" class="unnamed5"  style="font-size: 9pt;  color: #000000; background-color: #EAEAF4; solid #EAEAF4" onMouseOver ="this.style.backgroundColor='#ffffff'" onMouseOut ="this.style.backgroundColor='#EAEAF4'"  style="font-size: 9pt;  color: #000000; background-color: #EAEAF4; solid #EAEAF4" onMouseOver ="this.style.backgroundColor='#ffffff'" onMouseOut ="this.style.backgroundColor='#EAEAF4'">&nbsp;&nbsp;
		<input type="submit" value=" 添 加 " name="Submit" class="unnamed5" OnClick="document.form1.Content.value =frames.message.document.body.innerHTML;" style="font-size: 9pt;  color: #000000; background-color: #EAEAF4; solid #EAEAF4" onMouseOver ="this.style.backgroundColor='#ffffff'" onMouseOut ="this.style.backgroundColor='#EAEAF4'" style="font-size: 9pt;  color: #000000; background-color: #EAEAF4; solid #EAEAF4" onMouseOver ="this.style.backgroundColor='#ffffff'" onMouseOut ="this.style.backgroundColor='#EAEAF4'">&nbsp;
		<input type="reset" value=" 重 置 " name="Reset" class="unnamed5" style="font-size: 9pt;  color: #000000; background-color: #EAEAF4; solid #EAEAF4" onMouseOver ="this.style.backgroundColor='#ffffff'" onMouseOut ="this.style.backgroundColor='#EAEAF4'" style="font-size: 9pt;  color: #000000; background-color: #EAEAF4; solid #EAEAF4" onMouseOver ="this.style.backgroundColor='#ffffff'" onMouseOut ="this.style.backgroundColor='#EAEAF4'">
