...
IF request.cookies(Forcast_SN)("KEY")<>"super" THEN
	...
	<div align="center"><a href="mailto:info@ajiang.net">阿江</a>改写的ASP探针-<font class=fonts>V1.8</font><br>
	  <br>
	  ...
	  1、访问本文件时提示下载。
	  <br>
	  2、访问本文件时看到类似“&lt;%@ Language="VBScript" %&gt;”的文字。 <br>
	  <br>
	...
	<br>
	<font class=fonts>磁盘相关测试</font>
	
	<br>
	■ 服务器磁盘信息
	
	<table class=backq border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#C0C0C0" width="100%">
