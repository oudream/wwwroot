...
<form method="POST" name="FrmAddLink" LANGUAGE="javascript" onsubmit="return FrmAddLink_onsubmit()"   action="SaveAdminEdit.asp?id=<%=request("id")%>">
<tr>
...
<tr>
	...
	<td width="54%" height="32">
		<div align="left">
			<input name="username" size="20" value="<%=rs(db_ManageUser_Name)%>" <%if (rs(db_ManageUser_Name)<>request.cookies(Forcast_SN)("ManageUserName")  and request.cookies(Forcast_SN)("purview")="99999") or request.cookies(Forcast_SN)("purview")<>"99999" then%>readonly<%end if%> class="smallInput" maxlength="30" style="font-size: 9pt;  color: #000000; background-color: #EAEAF4; solid #EAEAF4" onMouseOver ="this.style.backgroundColor='#ffffff'" onMouseOut ="this.style.backgroundColor='#EAEAF4'">
		</div>
	</td>
</tr>
<tr>
	...
	<td width="54%" height="32">
		<div align="left">
			<input name="passwd" type="password" size="20" value="<%=rs(db_ManageUser_Password)%>" class="smallInput" maxlength="50" style="font-size: 9pt;  color: #000000; background-color: #EAEAF4; solid #EAEAF4" onMouseOver ="this.style.backgroundColor='#ffffff'" onMouseOut ="this.style.backgroundColor='#EAEAF4'">
		</div>
	</td>
</tr>
<tr>
