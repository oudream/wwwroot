...
%>
        ...
        <tr > 
          <td valign="middle" background="images/left.gif"  > 本站顾问<br>
            <br>
            权希军(北京) 刘炳森(北京)<br>
            肖 峰(浙江) 旭 宇(河北)<br>
            刘 江(浙江) 邹德忠(北京)<br>
            ...
            <%end if%>
              ...
              <tr> 
                <td height="34" background="images/left1-m7.gif"> </td>
		<tr>
          <TD height="30">本站编辑部<br>
            名誉站长:铁 峰<br>
            站长总编:柯亿鹏<br>
            作品编辑:叶 云<br>
            页面维护:林 婧<br>
            ...
            邮政03A-114信箱<br>
            邮 编：350003 　 <br>
            电 话：0591-87793602 87715001 <br>
            传 真：0591-87715001 </TD>
        </tr>
      </table>
</td>
      ...
      set rsb=nothing%>
          ...
          <table width="100%"  border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <tr> 
                <td align="center"><img src="pic/right_art.gif" width="134" height="123"></td>
            </tr>
          </table></td>
        </tr>
        <tr> 
