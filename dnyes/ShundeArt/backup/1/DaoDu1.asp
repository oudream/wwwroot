...
<table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse" width="450" id="AutoNumber3">
	<tr >
		<td background="images/hotnews.gif" height="52" colspan="3">&nbsp;</td>
	</tr>
	<tr> 
									...
									<TABLE class=56 width="100%">
										<TBODY>
											<TR>
												...
												<a class=class target=_blank href="readnews.asp?newsid=<%=rs("newsid")%>" title="<%=title%>"><img src="<%=FileUploadPath & rs("picname")%>" width="240" border=0></a>
												</TD>
											</TR>
											<TR>
												<TD align=right></TD>
		...
		<td width=168  valign=top bgcolor="#FFFFFF" style="LEFT: 0px; WIDTH: 168px; WORD-WRAP: break-word">
			<strong>
				<font size=+1 face="楷体_GB2312" color="<%=rs("titlecolor")%>">
					<a title="<%=title%>"><%=htmlencode4(CutStr(title,24))%>
					</a>
				</font>
			</strong>
			<br>
			<br>
			<a class=class target=_blank href="ReadNews.asp?NewsId=<%=rs("newsid")%>" title="<%=htmlencode4(title)%>"><%=CutStr(nohtml(rs("Content")),200)%> </a>
