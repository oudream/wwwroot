...
memo=replace(memo,"'","''")
usql="select * from art_auction where allname='"&allname&"'"
...
if brief="" then brief=" "
if memo="" then memo=" "
sql="insert into art_auction (allname,classes,addr,tel,fax,zip,email,web_addr,creation_date,legal_representative,contacter,ctel,brief,memo,inserttime) values ('"&allname&"','"&classes&"','"&addr&"','"&tel&"','"&fax&"','"&zip&"','"&email&"','"&web_addr&"','"&creation_date&"','"&legal_representative&"','"&contacter&"','"&ctel&"','"&brief&"','"&memo&"','"&now()&"')"
conn.Execute(sql)
...
<FORM action="art_auction_add.asp" method="post" name="form_administrator" id="form_administrator" onSubmit="return checkform();">
    <TBODY>
      <TR align="center"> 
        <TD height=30 colspan="2"><font color="#FF0000" size="+1"><strong>拍卖行添加</strong></font></TD>
      </TR>
      <TR> 
      ...
      <TR> 
        ...
        <TD> <INPUT maxLength=40 size=30 id="legal_representative" name="legal_representative"> 
        </TD>
      </TR>
      <TR> 
        <TD align="right"> 联系人:</TD>
        <TD> <INPUT maxLength=40 size=30 id="contacter" name="contacter"> </TD>
      </TR>
      <TR> 
        <TD align="right"> 联系人电话:</TD>
        <TD> <INPUT maxLength=100 size=30 id="ctel" name="ctel"> </TD>
      </TR>
      <TR> 
