...
function changedata1() {
	if ( document.AddReview.none1.checked ) {
		document.AddReview.email.value = "guest@shundeart.com";
	} 
}
...
if rs1.EOF then  NoReview=1
	...
	<%if reviewable="1" then%>  
		<form method="POST" action="AddReview.asp" name=AddReview  onSubmit="return CheckFormAddReview();">
				...
				%>
				 <tr> 
					<td width="100%" align="center" background="images/menu-guest-l.gif">
...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="bottom">
	 <tr> 
        ...
        <tr> 
          <td width="20"></td>
          <td  width="255" height="20"> <a href=Review.asp?NewsID=<%=NewsID%> target="_blank" class=bottom><img src="images/icon1.gif"  border="0">发表、查看更多关于该信息的评论</a> 
          </td>
          <td  width="214" height="20"> <a href=send.asp?NewsID=<%=NewsID%> target=_blank  class=bottom><img src="images/mail.gif"  border="0">将本信息发给好友</a> 
          </td>
