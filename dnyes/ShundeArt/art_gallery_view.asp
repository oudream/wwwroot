...
<table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bordercolor="#CCCCCC">
  <tr bgcolor="#FFFFFF"> 
    <td height="30" colspan="9" align="center" class="header"><font color="#FF0000" size="+1"><strong>中国画廊列表</strong></font></td>
  </tr>
  <tr align="center"> 
    <td width="100" bgcolor="#FFFFFF">名称</td>
    <td bgcolor="#FFFFFF">地址</td>
    <td width="100" bgcolor="#FFFFFF">电话</td>
    <td width="100" bgcolor="#FFFFFF">传真</td>
    <td width="130" bgcolor="#FFFFFF">网址</td>
    <td width="100" bgcolor="#FFFFFF">负责人</td>
...
%>
  <tr align="center"> 
    ...
    <td width="200" bgcolor="#FFFFFF"><a href="art_gallery_viewall.asp?art_gallery_id=<%=rs("art_gallery_id")%>" target="_blank">详细</a>&nbsp; | &nbsp;<a href="art_gallery_edit.asp?art_gallery_id=<%=rs("art_gallery_id")%>">编辑</a>&nbsp; | &nbsp;<a href="art_gallery_view.asp?art_gallery_id=<%=rs("art_gallery_id")%>&option=del" onClick="return confirm('确定删除此项吗？')">删除</a>&nbsp;</td>
  </tr>
  <%
rs.movenext
i=i+1                                                                     
