...
usql="select * from art_user where uid='"&uid&"' or uname='"&uname&"'"
...
if memo="" then memo=" "
if uname<>"" then
sql="insert into art_user (uname,addr,tel2,tel3,fax,email,qq,msn,uid,pwd,memo,inserttime) values ('"&uname&"','"&addr&"','"&tel2&"','"&tel3&"','"&fax&"','"&email&"','"&qq&"','"&msn&"','"&uid&"','"&pwd&"','"&memo&"','"&now()&"')"
conn.Execute(sql)
...
<!--                                                   ERROR MSGS
<!-------------------------------------------------------------------------------------------------------------------- -->
<FORM action="art_user_add.asp" method="post" name="form_administrator" id="form_administrator" onSubmit="return checkform();">
...
<!------------------------------------------------------------------------------------------------------------------------------------ -->
        ...
        <TD width=396><INPUT maxLength=100 size=30 id="uname" name="uname">
          *</TD>
      </TR>
      <TR> 
      ...
      <TR> 
        ...
        <TD width=396><INPUT maxLength=100 size=30 id="tel2" name="tel2">
          *</TD>
      </TR>
      <TR> 
        <TD width=120 height=45> 电话2</TD>
        <TD width=396><INPUT maxLength=100 size=30 id="tel3" name="tel3">
          *</TD>
      </TR>
      <TR> 
...
<!------------------------------------------------------------------------------------------------------------------------------------ -->
      <TR> 
        ...
        <TD width=396><INPUT maxLength=40 size=30 id="qq" name="qq">
          *</TD>
      </TR>
        <!---------------------------------------------------------------------------------------------------------------------------------------
<!                     							              email
<!------------------------------------------------------------------------------------------------------------------------------------ -->
      <TR> 
        ...
        <TD width=396><INPUT maxLength=40 size=30 id="msn" name="msn">
          *</TD>
      </TR>
      <!---------------------------------------------------------------------------------------------------------------------------------------
<!                     							              USERID
...
<!------------------------------------------------------------------------------------------------------------------------------------ -->
      ...
      <TR> 
        <TD height="50" colSpan=2> <P><INPUT type=submit id="option" name="option" value="add">
            &nbsp;&nbsp; 
