...
conn.execute "delete * from art_shopper_govermente where art_shopper_govermente_id=" & request("art_shopper_govermente_id")
...
<form name="form_administrator" id="form_administrator" method="post" action="art_shopper_govermente_view.asp">
    ...
    <tr align="center" valign="middle"> 
      ...
      <td height="30">会长： 
        <input name="zcontacter" type="text" id="zcontacter" size="20" maxlength="100" value="<%=zcontacter%>"></td>
      <td>其它： 
...
sql="select * from art_shopper_govermente where allname<>'' " 
...
if zcontacter<>"" then sql=sql & " and contacter like '%"&zcontacter&"%'"
...
sql = sql &" order by art_shopper_govermente_id DESC"
...
<table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bordercolor="#CCCCCC">
  <tr bgcolor="#FFFFFF"> 
    <td height="22" colspan="8" align="center" class="header"><font color="#FF0000" size="+1"><strong>客户列表</strong></font></td>
  </tr>
  <tr align="center"> 
    <td width="100" height="30" bgcolor="#FFFFFF">全称</td>
    <td bgcolor="#FFFFFF">地址</td>
    <td width="100" bgcolor="#FFFFFF">电话</td>
    <td width="100" bgcolor="#FFFFFF">传真</td>
    <td width="100" bgcolor="#FFFFFF">联系人</td>
...
%>
  <tr align="center"> 
    <td height="25" bgcolor="#FFFFFF"><a href="art_shopper_govermente_edit.asp?art_shopper_govermente_id=<%=rs("art_shopper_govermente_id")%>"><%=rs("allname")%></a>&nbsp;</td>
    <td bgcolor="#FFFFFF"><%=rs("addr")%>&nbsp;</td>
    <td bgcolor="#FFFFFF"><%=rs("tel")%>&nbsp;</td>
    <td bgcolor="#FFFFFF"><%=rs("fax")%>&nbsp;</td>
    <td bgcolor="#FFFFFF"><%=rs("contacter")%>&nbsp;</td>
    <td bgcolor="#FFFFFF"><a href="art_shopper_govermente_viewall.asp?art_shopper_govermente_id=<%=rs("art_shopper_govermente_id")%>" target="_blank">详细</a>&nbsp; | &nbsp;<a href="art_shopper_govermente_edit.asp?art_shopper_govermente_id=<%=rs("art_shopper_govermente_id")%>">编辑</a>&nbsp; | &nbsp;<a href="art_shopper_govermente_view.asp?art_shopper_govermente_id=<%=rs("art_shopper_govermente_id")%>&option=del" onClick="return confirm('确定删除此项吗？')">删除</a>&nbsp;</td>
  </tr>
  <%
rs.movenext
i=i+1                                                                     
...
if zj<=zk*15 then
%>
          <td><a href="art_shopper_govermente_view.asp?zname=<%=zname%>&zaddr=<%=zaddr%>&ztel=<%=ztel%>&zfax=<%=zfax%>&zcontacter=<%=zcontacter%>&zothers=<%=zothers%>&page=<%=zj%>">&nbsp;<%=zj%>&nbsp;</a></td>
          <%
else
zk=zk+1
%>
