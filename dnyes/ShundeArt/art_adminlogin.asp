...
%>
<%
if session("user_adminlevel")=1 or session("user_adminlevel")=3 then
%>
<table width="100%" height="100%" border="0" cellpadding="2" cellspacing="2">
        <tr> 
          <td height="410" align="center">Welcome, <font color="#FF0000"><%=session("user_name")%></font> 
            ! You have logined <%=session("user_id")%><%=session("user_adminlevel")%></td>
        </tr>
        <tr>
...
<table width="100%" height="100%" border="0" cellpadding="2" cellspacing="2">
		...
		<td width="1">&nbsp;</td>
          <td align="center">
               <form action="art_login.asp" method="post" name="form_administrator" id="form_administrator" onSubmit="return checkform();">
        <table width="168" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr> 
            <td><input type="text" maxlength=20 name="uid" id="uid" size=30></td>
          </tr>
          <tr> 
            <td>Password : </td>
          </tr>
          <tr> 
            <td><input type="password" maxlength=20 name="pwd" id="pwd" size=30></td>
          </tr>
          <tr>
