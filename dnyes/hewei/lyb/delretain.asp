...
<%
if Request("menu") = "delretain" then
call delretain()
else call index()
end if
  ...
  <div align=center> 
    <table cellspacing=0 cellpadding=0 width=520 border=0 align="center">
      ...
      <table border="0" cellpadding="2" cellspacing="0" style="border-collapse: collapse" bordercolor="#4F4F4F" width="100%" bgcolor="#F8FCF8">
        <tr>
          <td width="75%" class="shadow">当前位置:<a href=<%=url%>><%=name%></a> - <a href=index.asp>留言首页</a> - 删除用户</td>                     
...
<table cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#4F4F4F" width="100%" height="3">                     
  <tr>                     
    ...
    <table cellspacing=0 cellpadding=0 width=520 border=0 align="center">                 
      ...
      <td width="100%" bgcolor="#FFFFFF">                 
      <table border="0" cellpadding="2" cellspacing="0" style="border-collapse: collapse" bordercolor="#4F4F4F" width="100%" bgcolor="#F8FCF8">                 
        <form name="form" method="post" action="delretain.asp">  
    <input type=hidden name=menu value=delretain>  
    <tr>  
...
if message <> "" then  
	...
	sql = "delete * from retain where retain_name='"&retain_name&"'"  
