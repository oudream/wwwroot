...
function FDRmakeStr(){
	...
	for (i=0;i<FDRhdlineCount;i++){
		...
		if (isLink) {
			tempStr += "<table cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#4F4F4F' width='100%'><tr><td width='100%' align='center' class='shadow'><A "
					+ "HREF='" + prefix + linkStr + "'>"
		            + dispStr + "</A></td></tr></table>"
		}
		else {
			tempStr += ((NS4) ? "<table cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#4F4F4F' width='100%'><tr><td width='100%' align='center' class='shadow'>" : "<table cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#4F4F4F' width='100%'><tr><td width='100%' align='center' class='shadow'>") +dispStr+"</td></tr></table>";
