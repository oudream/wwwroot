      ...
      <table border="0" cellpadding="2" cellspacing="0" style="border-collapse: collapse" bordercolor="#4F4F4F" width="100%" bgcolor="#F8FCF8">
        <tr>
          <td width="75%" class="shadow">当前位置:<a href=<%=url%>><%=name%></a>  
            - <a href=index.asp?userid=<%=userid%>>留言首页</a>             
            - 浏览留言</td>            
          ...
          <td width="15%" align="center"><a href="index.asp"><img border="0" src="images/read.gif"></a></td>              
          <td width="40%">              
          ...
          <a href="http://www.sczz.com/book/register.asp" target="_blank">              
          <img border="0" src="images/register.gif"></a></td>              
