...
function CheckForm()
{
    ...
    if(letter.indexOf(ADDUser.uid.value.charAt(i)) == -1)
  {
	...
	if (document.ADDUser.pwd.value != document.ADDUser.PW_Again.value) {
		...
		document.ADDUser.pwd.focus();
		return false;
	}if (document.ADDUser.contact_cn.value.length == 0) {
		alert("请输入联系人的中文姓名.");
		document.ADDUser.contact_cn.focus();
		return false;
                            ...
                            <tr> 
                              <td height="8" colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                                  <tr> 
                                    ...
                                    <td valign="bottom" background="images/host-2.gif">用 户 注 册 >> 个 人 用 户 注 册 表</td>
                                  </tr>
                                </table>
                                ...
                                <table width="498" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#cccccc">
                                  <form name="ADDUser" method="POST" action="userregfix.asp" onSubmit="return CheckForm();">
                                    <tr> 
                                      <td width="128" bgcolor="#f5f5f5">用户帐号：</td>
                                    ...
                                    <tr> 
                                      ...
                                      <td width="188" colspan="2" bgcolor="#FFFFFF"><input name="contact_cn" type="text"  size="21" maxlength="20"></td>
                                      <td colspan="3" bgcolor="#FFFFFF" ><font color="#CC0000">*</font></td>
                                    </tr>
                                    <tr> 
                                    ...
                                    <tr> 
                                      ...
                                      <td width="108" colspan="2" bgcolor="#FFFFFF" id="td8"><select name="TECHSP_CN" >
                                    ...
                                    <tr> 
                                      ...
                                      <td colspan="2" bgcolor="#FFFFFF"> <input type="text" name="fax_gov_code"  maxlength="5" size="3" class="form" value="86">
                                        ...
                                        - 
                                        <input type="text" name="fax_ext_code"  maxlength="7" size="5" class="form"> 
                                      </td>
                                      <td colspan="3" bgcolor="#FFFFFF" >&nbsp;</td>
                                    </tr>
                                    <tr> 
                                    ...
                                    <tr> 
                                      <td height="40" colspan="6" align="center" bgcolor="#f5f5f5"> 
                                        <input class="botton" type="submit" name="ok" value="提交申请"> 
                                        <input type="hidden" name="adduser" value="true"> 
                                        <input type="hidden" name="usertype" value="pers"></td>
                                    </tr>
                                  </form>
                                </table> </td>
                            </tr>
