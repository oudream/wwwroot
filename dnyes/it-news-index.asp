...
<table width="98%" border="0" cellpadding="0" cellspacing="0">
  <%
sqlnews="select id,subject,message,color from message where newstype='行业信息' order by id desc" 
...
%>
  <tr> 
    <td colspan="2"><div align="right"><a href="viewnews.asp?newstype=行业信息" >更多&gt;&gt;</a></div></td>
  </tr>
</table>
<TABLE width=70% border=0 cellPadding=0 cellSpacing=0>
  <TBODY>
