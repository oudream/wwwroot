...
usql="select * from dbm_guest where ( allname='"&allname&"' or simname='" & simname&"' ) and guest_id<>" & request("guest_id")
...
<TABLE width=100% 
  ...
  <FORM action="dbm_guest_edit.asp" method="post" name="form_administrator" id="form_administrator" onSubmit="return checkform();">
    <TBODY>
      <TR align="center"> 
        <TD height=30 colspan="2"><font color="#FF0000" size="+1"><strong>客户编缉</strong></font></TD>
      </TR>
      <TR> 
        <TD width="46%" align="right"> 名称(公司或个人)：</TD>
        <TD> <input maxlength=100 size=30 id="allname" name="allname" value="<%=rs("allname")%>" disabled>
          * 此项至关重要，不能修改</TD>
      </TR>
      <TR> 
      ...
      <TR> 
        ...
        <TD> <INPUT maxLength=50 size=30 id="gid" name="gid" value="<%=rs("gid")%>"> *  </TD>
      </TR>
      <TR> 
        <TD align="right"> 密码：</TD>
        <TD> <INPUT maxLength=50 size=30 id="pwd" name="pwd" value="<%=rs("pwd")%>"> *  </TD>
      </TR>
      <TR> 
        <TD align="right"> 重复密码：</TD>
        <TD> <INPUT maxLength=50 size=30 id="cpwd" name="cpwd" value="<%=rs("pwd")%>"> *  </TD>
      </TR>
      <TR> 
