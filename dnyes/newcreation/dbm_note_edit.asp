...
response.Redirect("dbm_note_view.asp?option_id_del=succ")
end if
%>
<%
...
conn.Execute("update dbm_note set subject='"&subject&"', memo='"&memo&"' where id=" & request("zid"))
...
<TABLE width=100% 
  ...
  <FORM action="dbm_note_edit.asp" method="post" name="form_administrator" id="form_administrator" onSubmit="return checkform();">
    <TBODY>
      <TR align="center"> 
        <TD height=30 colspan="2"> <DIV align=center></DIV>
          <font color="#FF0000"><strong>留言编缉</strong></font></TD>
      </TR>
      <TR align="center">
        <TD colspan="2">&nbsp;</TD>
      </TR>
      <TR> 
        <TD width="46%" align="right">留言名称：</TD>
        <TD width=396> <input maxlength=100 size=30 id="subject" name="subject" value="<%=rs("subject")%>">
          * </TD>
      </TR>
      <TR> 
        <TD width="150" height=155 align="right"> 留言：</TD>
