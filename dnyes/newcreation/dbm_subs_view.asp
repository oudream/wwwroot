...
<table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bordercolor="#CCCCCC">
  <%
sql="select * from dbm_subs where FILETITLE<> ''"

if zname<>"" then sql=sql & " and FILETITLE like '%"&zname&"%'"
if zothers<>"" then sql=sql & " and ( subs_id like '%"&zothers&"%' or simg like '%"&zothers&"%' or FILEDESC like '%"&zothers&"%' or memo like '%"&zothers&"%')"
...
%>
  <tr align="center"> 
    <td width="120" height="30" bgcolor="#FFFFFF"><%=rs("FILETITLE")%>&nbsp;</td>
