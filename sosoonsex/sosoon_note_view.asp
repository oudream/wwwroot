...
sql="select * from sosoon_note order by id desc" 
...
%>
                <td width="50"><a href="sosoon_note_view.asp?page=<%=zj%>">&nbsp;<%=zj%>&nbsp;</a></td>
                <%
zj=zj+1
next
%>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="66%"><strong><font size="5">备忘列表 </font></strong></td>
          <td width="34%" align="right"><font size="4"><strong><a href="sosoon_note_add.asp">备忘添加</a></strong></font></td>
        </tr>
      </table></td>
  </tr>
  <tr> 
    <td width="130" align="center" bgcolor="#FFFFFF">题摘</td>
    <td width="70" align="center" bgcolor="#FFFFFF">备忘人</td>
    <td width="80" align="center" bgcolor="#FFFFFF">备忘时间</td>
    <td width="320" align="center" bgcolor="#FFFFFF">备忘</td>
  </tr>
  <%
...
%>
  <tr> 
    <td width="130" align="center" bgcolor="#FFFFFF"><a href="sosoon_note_edit.asp?zid=<%=rs("id")%>"><%=rs("subject")%></a>&nbsp;</td>
    <td width="70" align="center" bgcolor="#FFFFFF">
<%
usql="select * from user where id="&rs("user_id") 
Set urs=Server.CreateObject("ADODB.RecordSet") 
...
%>
  <tr align="center" bgcolor="#FFFFFF"> 
    <td height="35" colspan="8"><font size="4"><strong><a href="sosoon_note_add.asp">备忘添加</a></strong></font></td>
  </tr>
</table>
<%
rs.close
