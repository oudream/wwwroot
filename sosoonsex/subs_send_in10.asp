...
function getbrand(targ,selObj,restore,sort_id){ 
  eval(targ+".location='subs_send_in10.asp?option="+'取消选择'+"&sort_id="+sort_id+"&brand_id="+selObj.options[selObj.selectedIndex].value+"'");
...
%>
<form name="form_administrator" method="post" action="subs_send_in10.asp" onSubmit="return checkform();">
