...
usql="select * from user where id<>"&session("user_id")&"and uid='"&uid&"'"
...
if memo="" then memo=" "
if uname<>"" then
conn.Execute("update user set uname='"&uname&"',addr='"&addr&"',tel2='"&tel2&"',tel3='"&tel3&"',fax='"&fax&"',email='"&email&"',qq='"&qq&"',msn='"&msn&"',uid='"&uid&"',pwd='"&pwd&"',memo='"&memo&"' where id=" & session("user_id"))
