          ...
          <TR> 
            <TD vAlign=top align=left> <TABLE width=100% height="30" border=0>
              ...
              <TABLE width=100% border=1 cellpadding="5" cellspacing="0" bordercolor="#cccccc" bgcolor="#f5f5f5">
                <TBODY>
                  <TR>
                    <TD height="25"><strong><font color="#FF0000">商品流通管理</font></strong></TD>
                  </TR>
                  <TR> 
                    <TD width=118 height="25"><a href="subs_select.asp?passtype=in" target="mainFrame">商品进货</a></TD>
                  </TR>
                  <TR> 
                    <TD height="25"><a href="subs_select.asp?passtype=out" target="mainFrame">商品出货</a></TD>
                  </TR>
                  <TR> 
                    <TD height="25"><a href="subs_pass_view.asp" target="mainFrame">商品流通的查看修改</a></TD>
                  </TR>
                </TBODY>
              </TABLE>
              <br>
              <TABLE width=100% border=1 cellpadding="5" cellspacing="0" bordercolor="#cccccc" bgcolor="#f5f5f5">
                <TBODY>
                  <TR>
                    <TD height="25"><strong><font color="#FF0000">金钱流通管理</font></strong></TD>
                  </TR>
                  <TR> 
                    <TD width=118 height="25"><a href="money_pass.asp?" target="mainFrame">金钱流通</a></TD>
                  </TR>
                  <TR> 
                    <TD height="25"><a href="money_pass_view.asp" target="mainFrame">金钱流通的查看修改</a></TD>
                  </TR>
                </TBODY>
              </TABLE>
              <br>
...
%>
              <TABLE width=100% border=1 cellpadding="5" cellspacing="0" bordercolor="#cccccc" bgcolor="#f5f5f5">
                <TBODY>
                  <TR>
                    <TD height="25"><strong><font color="#FF0000">高级操作</font></strong></TD>
                  </TR>
                  <TR> 
                    <TD width=118 height="25"><a href="money_guest.asp?" target="mainFrame">金钱初始化</a></TD>
                  </TR>
                  <TR> 
                    <TD width=118 height="25"><a href="subs_base_view.asp?" target="mainFrame">数信仓库状况</a></TD>
                  </TR>
                  <TR> 
                    <TD width=118 height="25"><a href="money_base_view.asp?" target="mainFrame">数信债权状况</a></TD>
                  </TR>
                </TBODY>
              </TABLE>
              <br>
...
%>
              <TABLE width=100% border=1 cellpadding="5" cellspacing="0" bordercolor="#cccccc" bgcolor="#f5f5f5">
                <TBODY>
                  <TR>
                    <TD height="25"><strong><font color="#FF0000">金钱流通类型</font></strong></TD>
                  </TR>
                  <TR> 
                    <TD width=169 height="25"><a href="moneypasstype_add.asp" target="mainFrame">金钱流通类型添加</a></TD>
                  </TR>
                  <TR> 
                    <TD height="25"><a href="moneypasstype_view.asp" target="mainFrame">金钱流通类型查看修改</a></TD>
                  </TR>
                </TBODY>
              </TABLE>
              <br>
