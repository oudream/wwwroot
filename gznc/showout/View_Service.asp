...
if (document.images)
	{
	i0 = new Image;
	i0.src = '../img/nc_service_001.gif';
	SiClickGoTo[0] = "#";
	imgPath[0] = i0.src;
	i1 = new Image;
	i1.src = '../img/nc_service_002.gif';
	SiClickGoTo[1] = "#";
	imgPath[1] = i1.src;
	i2 = new Image;
	i2.src = '../img/nc_service_002.gif';
	SiClickGoTo[2] = "#";
	imgPath[2] = i2.src;
	}
a = 0;
...
function StartAnim()
	...
	if (document.images)
		{
		document.write('<IMG SRC="../img/nc_service_001.gif" BORDER=0  NAME=defil style="filter:progid:DXImageTransform.Microsoft.Pixelate(MaxSquare=100,Duration=1)">');
		defilimg()
		}
	else
		{
		document.write('<A HREF="#"><IMG SRC="../img/nc_service_001.gif" BORDER=0></A>')
		}
	}
function ImgDest()
	{
...
<table width="990" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    <td valign="top"><table width="990" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td width="479">&nbsp;</td>
          <td width="341" valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
              ...
              <tr>
                <td height="8"><table width="75%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td height="8"><img src="../img/1.gif" width="1" height="1"></td>
                    </tr>
                  </table></td>
              </tr>
              <tr>
                <td height="10" background="../img/5x5.gif"><table width="75%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td height="8"><img src="../img/1.gif" width="1" height="1"></td>
                    </tr>
                  </table></td>
              ...
              <tr>
                <td valign="top" background="../img/5x5.gif"><table width="328" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <form name="form1" method="post" action="../dbm_login.asp" target="_blank">
                      <tr> 
                        <td width="94" height="15" align="right" valign="top"><font color="#CCCCCC">客户名称:&nbsp;</font></td>
                        <td valign="top"> <input maxlength=20 name="uid" id="uid" size=30 class="input" style="FONT-SIZE: 12px; WIDTH: 150px; background:white;border:1px solid #6184A3" onMouseOver="this.style.border='1px solid red'" onMouseOut="this.style.border='1px solid #6184A3'"></td>
                      </tr>
                      <tr> 
                        <td height="15" colspan="2">&nbsp;</td>
                      </tr>
                      <tr> 
                        <td height="15" align="right" valign="top"><font color="#CCCCCC">密 
                          码:&nbsp;</font></td>
                        <td valign="top"><input maxlength=20 name="pwd" id="pwd" size=30 type=password class="input" style="FONT-SIZE: 12px; WIDTH: 150px; background:white;border:1px solid #6184A3" onMouseOver="this.style.border='1px solid red'" onMouseOut="this.style.border='1px solid #6184A3'"></td>
                      </tr>
                      <tr> 
                        <td height="15" align="right" valign="top">&nbsp;</td>
                        <td valign="top"><br> <input type="hidden" name="user_adminlevel" id="user_adminlevel" value=9> 
                          <input name="Submit" type="submit" class="button" id="Submit" value="登 录"></td>
                      </tr>
                      <tr> 
                        <td colspan="2" valign="top"><font color="#CCCCCC">{客户沟通}<br>
                          <br>
                          敬爱的客户，请在右边的登录入口填入我们为您开设的帐号和密码，然后点击“登录”。如果帐号密码正确，您可以进入查看您的项目的相关资源，给我们留言，当然还有上传和下载相关资源的权限。 
                          如发现帐号密码不能正常使用的，请与我们联系。谢谢！<br>
                          <br>
                          广州新筑建筑设计咨询有限公司<br>
                          地址:广州先烈中路100号大院省科技图书馆后座9-1号201室　<br>
                          邮编:510070<br>
                          E-mail: work@gznc.com.cn / support@gznc.com.cn<br>
                          电话:（020）87687181 / 87687182<br>
                          Fax:（020）87681930<br>
                          网址:www.gznc.com.cn<br>
                          </font></td>
                      </tr>
                    </form>
                  </table></td>
  ...
  <tr> 
    <td height="33"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="990" height="33">
        <param name="movie" value="../img/index/service.swf">
        <param name="quality" value="high">
        <embed src="../img/index/service.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="990" height="33"></embed></object></td>
  </tr>
  <tr> 
