<img onclick=Cbold() src="<%=Forum_info(7)&Forum_ubb(0)%>" width="22" height="22" alt="粗体" border="0">
<img onclick=Citalic() src="<%=Forum_info(7)&Forum_ubb(1)%>" width="23" height="22" alt="斜体" border="0">
<img onclick=Cunder() src="<%=Forum_info(7)&Forum_ubb(2)%>" width="23" height="22" alt="下划线" border="0">
<img onclick=Ccenter() src="<%=Forum_info(7)&Forum_ubb(3)%>" width="22" height="22" alt="居中" border="0">
<img onclick=Curl() src="<%=Forum_info(7)&Forum_ubb(4)%>" width="22" height="22" alt="超级连接" border="0">
<img onclick=Cemail() src="<%=Forum_info(7)&Forum_ubb(5)%>" width="23" height="22" alt="Email连接" border="0">
<img onclick=Cimage() src="<%=Forum_info(7)&Forum_ubb(6)%>" width="23" height="22" alt="图片" border="0">
<img onclick=Cswf() src="<%=Forum_info(7)&Forum_ubb(7)%>" width="23" height="22" alt="Flash图片" border="0">
<img onclick=Cdir() src="<%=Forum_info(7)&Forum_ubb(8)%>" width="23" height="22" alt="Shockwave文件" border="0">
<img onclick=Crm() src="<%=Forum_info(7)&Forum_ubb(9)%>" width="23" height="22" alt="realplay视频文件" border="0">
<img onclick=Cwmv() src="<%=Forum_info(7)&Forum_ubb(10)%>" width="23" height="22" alt="Media Player视频文件" border="0">
<img onclick=Cmov() src="<%=Forum_info(7)&Forum_ubb(11)%>" width="23" height="22" alt="QuickTime视频文件" border="0">

<img onclick=Cquote() src="<%=Forum_info(7)&Forum_ubb(12)%>" width="23" height="22" alt="引用" border="0">
<IMG onclick=Cfly() height=22 alt=飞行字 src="<%=Forum_info(7)&Forum_ubb(13)%>" width=23 border=0>
<IMG onclick=Cmarquee() height=22 alt=移动字 src="<%=Forum_info(7)&Forum_ubb(14)%>" width=23 border=0>
<IMG onclick=Cguang() height=22 alt=发光字 src="<%=Forum_info(7)&Forum_ubb(15)%>" width=23 border=0>
<IMG onclick=Cying() height=22 alt=阴影字 src="<%=Forum_info(7)&Forum_ubb(16)%>" width=23 border=0>
<br>
字体：
