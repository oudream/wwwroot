...
if request("option")="editplayerissucc" then response.Write("<SCRIPT LANGUAGE=JavaScript> alert(' Edit Player is complete. ');</SCRIPT>")
...
%>
				<a href="player_e.asp?pid=<%=prs("pid")%>" > EDIT </a>
<%
end if
%>
				</td>
