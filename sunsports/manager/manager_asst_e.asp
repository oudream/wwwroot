...
conn.Execute("update player set name='"&uname&"',uid='"&uid&"',pwd='"&pwd&"',tel='"&tel&"',zip='"&zip&"',contact='"&contact&"',email='"&email&"',nric='"&nric&"',jersey="&jersey&" where pid=" & pid)
conn.Execute("update card set pname='"&uname&"' where pid=" & pid)
conn.Execute("update scorer set pname='"&uname&"' where pid=" & pid)

response.Redirect("team_t.asp?option=editasstmanagerissucc")
