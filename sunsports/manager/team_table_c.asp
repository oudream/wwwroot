...
conn.Execute(sql)
response.Redirect("team_table_e.asp?option=createtableissucc")
end if
%>
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    ...
    <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr> 
          <td height="30"><h2><FONT face="Verdana, Arial, Helvetica, sans-serif" color=#000066>Team's Standing / Table Add</font></h2></td>
        </tr>
      </table></td>
    <td>&nbsp;</td>
  </tr>
...
<form id="zform" action="team_table_c.asp" onSubmit="return checkform();" method="post">
	    <table width="100%" border="0" cellspacing="2" cellpadding="2">
          <tr> 
            <td colspan="3"><strong> standings:</strong></td>
          </tr>
          <tr> 
            <td width="12%">Played:&nbsp;</td>
            <td width="84%"><input name="Played" id="Played" type="text" size="10" maxlength="5" ></td>
            <td width="4%">&nbsp;</td>
          </tr>
          <tr> 
            <td>Win: </td>
...
%>
        ...
        <input type="hidden" id="tname" name="tname" value=<%=trs("name")%>> 
<%
end if
trs.close
set trs=nothing
