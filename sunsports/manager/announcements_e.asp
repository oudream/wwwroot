...
<FORM action="announcements_e.asp" method=post name="form_administrator" id="form_administrator" onSubmit="return checkform();">
        <table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
          <tr> 
            <td bgcolor="#f5f5f5"><strong>SENT TIME:</strong></td>
            <td bgcolor="#FFFFFF"> <input type="text" id="inserttime" name="inserttime" maxlength="100" size="30" value="<%=rs("inserttime")%>" class="form"> 
            </td>
          </tr>
          <tr> 
            <td bgcolor="#f5f5f5"><strong>CONTENT:</strong></td>
            <td bgcolor="#FFFFFF"><textarea name="content" id="content" cols="50" rows="10"><%=rs("content")%></textarea></td>
          </tr>
          <tr align="center" bgcolor="#FFFFFF"> 
            <td bgcolor="#f5f5f5">&nbsp; </td>
            <td> <input type="hidden" id="id" name="id" value=<%=aid%>> <input type="submit" id="option" name="option" value="edit"> 
