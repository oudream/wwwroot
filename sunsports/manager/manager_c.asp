...
sql="insert into player (name,tel,zip,contact,email,uid,pwd,nric,adminlevel,ptype,jersey,inserttime) values ('"&uname&"','"&tel&"','"&zip&"','"&contact&"','"&email&"','"&uid&"','"&pwd&"','"&nric&"',"&adminlevel&",'"&"m"&"',"&jersey&",'"&now()&"')"
conn.Execute(sql)
...
<!------------------------------------------------------------------------------------------------------------------------------------ -->
      <TR> 
        ...
        <TD><FONT face="Verdana, Arial, Helvetica, sans-serif" 
                        color=#000000 size=3>
          <input maxlength=10 size=30 id="nric2" name="nric">
          </FONT></TD>
      </TR>
      <!---------------------------------------------------------------------------------------------------------------------------------------
<!                     							              USERID
