...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr> 
    ...
    <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr> 
          <td height="30" align="center" valign="middle"><h2><strong><font color="#FF0000"></font> 
              Match Result Edit</strong></h2></td>
        </tr>
      </table></td>
    <td>&nbsp;</td>
  </tr>
  <tr> 
    ...
    <td> <table width="100%" border="1" cellpadding="3" cellspacing="0" bordercolor="#CCCCCC">
        <tr> 
          ...
          <td width="32%"><%=mrs("mweek")%></td>
          <td width="51%">&nbsp;</td>
        </tr>
        <tr> 
          <td width="17%"><b>Date</b></td>
          <td width="32%"><%=mrs("mmonth")&"/"&mrs("mday")&"/"&mrs("myear")%></td>
          <td width="51%">&nbsp;</td>
        </tr>
        <tr> 
          <td width="17%"><b>Time</b></td>
          <td width="32%"><%=mrs("mhour")&":"&mrs("mminute")%></td>
          <td width="51%">&nbsp;</td>
        </tr>
        <%
...
%>
        <tr> 
          ...
          <td width="32%"><%=mrs("htname")%></td>
          <td width="51%"><%=hscore&" : "&ascore%>&nbsp;</td>
        </tr>
        <%
...
%>
        <tr> 
          ...
          <td width="32%"><%=mrs("atname")%></td>
          <td width="51%"><%=hscore&" : "&ascore%>&nbsp;</td>
        </tr>
        <tr> 
          <td width="17%"><b>Location</b></td>
          <td width="32%"><%=mrs("fname")%></td>
          <td width="51%">&nbsp;</td>
        </tr>
      </table></td>
    <td>&nbsp;</td>
	 ...
	 <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td><form id="howhform" action="match_r_e.asp" onSubmit="return check_howhform();" method="post">
              ...
              <table width="100%" border="0" cellspacing="2" cellpadding="2">
                <tr> 
                  <td width="33%"><strong><font color="#FF0000">STEP 1</font></strong></td>
                </tr>
              </table>
              <table width="100%" border="1" cellpadding="3" cellspacing="0" bordercolor="#CCCCCC">
                <tr> 
                  <td height="24"><strong>ITEMS</strong></td>
                  <td><strong>HOME TEAM</strong></td>
                  <td height="24"><strong>AWAY TEAM</strong></td>
                </tr>
                <tr> 
                  <td width="26%">How many player kicked in :</td>
                  <td><input name="hsnum2" type="text" id="hsnum2" size="5" maxlength="2" value=<%=hsnum%>></td>
                  <td><input name="asnum2" type="text" id="asnum2" size="5" maxlength="2" value=<%=asnum%>></td>
                </tr>
                <tr> 
                  <td>How many player discipline :</td>
                  <td><input name="hcnum2" id="hcnum2" type="text" size="5" maxlength="2" value=<%=hcnum%>></td>
                  <td><input name="acnum2" id="acnum2" type="text" size="5" maxlength="2" value=<%=acnum%>></td>
                </tr>
                <tr> 
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td> <form id="zhform" action="match_r_save.asp" method="post">
              ...
              <table width="100%" border="0" cellspacing="2" cellpadding="2">
                      <tr> 
                        <td width="28%"><strong><font color="#FF0000">STEP 2</font></strong></td>
...
%>
                  ...
                  <td> <input name="<%="hs"&cstr(i)%>" id="<%="hs"&cstr(i)%>" type="text" size="5" maxlength="2" value="<%=asi(i)%>">
                    -score</td>
                  <td>&nbsp;</td>
                </tr>
                <%
...
%>
                ...
                <tr> 
                  <td colspan="4"><select name="ouhrefer" id="ouhrefer">
                      <option value="<%=ouhrefer%>" selected><%=ouhrefer%></option>
<%
for i=1 to 10
if i<>ouhrefer then
%>
