...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    <td>&nbsp;</td>
    <td> <font color="#FF0000" size="3"><strong>Step 1: 
      </strong></font> 
      <table width="100%" cellpadding=0 cellspacing=0>
                <tbody>
                  <tr> 
                    
            <td width="35%"><b><font color=#000066 
                        face="Verdana, Arial, Helvetica, sans-serif">Select the 
              league/cup/friendlies in:</font></b></td>
                    <td align="left"> 
					<select name="cid" class="display_dropdown" id="cid" onchange="gettarg('self',this,0)">
                        <option selected value="">SELECT ... </option>
                        <option>------------------------------</option>
<%
sql="select * from tournament order by id_order" 
...
%>
              ...
              (<b><font color="#FF0000"><%=cname%></font></b> Now!)</td>
                  </tr>
                </tbody>
              </table>
<br>
<br>
      ...
      <font color="#FF0000" size="3"><strong>Step 2: 
      </strong></font> 
			</td>
          </tr>
          <tr> 
