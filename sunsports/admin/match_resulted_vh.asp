  ...
  <table width="100%" border="0" cellspacing="2" cellpadding="2">
    <tr> 
      ...
      <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
          ...
          <td height="30" align="center" valign="middle"><strong>HOME Match Result 
            VIEW</strong></td>
          </tr>
        </table></td>
      <td>&nbsp;</td>
...
%>
    ...
    <tr> 
      ...
      <td> 
        ...
        <tr bgcolor="#FFFFFF"> 
          <td width="305" height="25"><b><strong><a href="match_resulted_va.asp?mid=<%=mmid%>&htid=<%=htid%>&atid=<%=atid%>">The 
            Home Match Result Is OK</a></strong></b></td>
          <td width="36">&nbsp;</td>
          <td width="245"><b><strong><a href="match_r_c1.asp?option=deledit&mid=<%=mmid%>&htid=<%=htid%>&atid=<%=atid%>">Edit 
