...
function getcidweek(targ,cid,selObj,restore){ //v3.0
  eval(targ+".location='cup.asp?cid="+cid+"&mweek="+selObj.options[selObj.selectedIndex].value+"'");
...
response.Write("<SCRIPT LANGUAGE=JavaScript> alert(' No Cup you want in the databse ! ');</SCRIPT>")
response.End()
crs.close
set crs=nothing
end if
...
<%=cname%> -- Fixture and Result &nbsp;<a href="<%=xlsurl%>" target="_blank" onClick="return confirm('Because the file is bigger,it will take several minutes . Are you sure to look it ! ');">(click here to see Results map) </a>
	</b></td>
  </tr>
<%
