      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td><strong><font color="#1F4A71">Sunsports &amp; Recreation</font></strong><br>
            ...
            <li><FONT color="#666666">Soccer</FONT><br>
            <li><FONT color="#666666">Ball Games</FONT><br>
            <li><FONT color="#666666">X country</FONT><br>
            <li><FONT color="#666666">Island Cycling</FONT><br>
            <li><FONT color="#666666">Water Sports</FONT><br>
