...
if adminlevel=1 or adminlevel=3 then conn.execute "delete * from user where id=" & id
if adminlevel=2 then conn.execute "delete * from player where id=" & id
...
if nric="" then nric=" "
if uname<>"" then
if adminlevel=1 or adminlevel=3 then sql="update user set name='"&uname&"',contact='"&contact&"',email='"&email&"',nric='"&nric&"',uid='"&uid&"',pwd='"&pwd&"' where id=" & id
if adminlevel=2 then sql="update player set name='"&uname&"',contact='"&contact&"',email='"&email&"',nric='"&nric&"',uid='"&uid&"',pwd='"&pwd&"' where id=" & id
conn.Execute(sql)
url="user_v.asp?page=" & page & "&adminlevel=" & adminlevel
...
%>
<%
if adminlevel=1 or adminlevel=3 then sql="select * from user where id=" & id
if adminlevel=2 then sql="select * from player where id=" & id
